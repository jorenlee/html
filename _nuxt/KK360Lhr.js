 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const te=new nn("@firebase/app"),bn="@firebase/app-compat",vn="@firebase/analytics-compat",yn="@firebase/analytics",wn="@firebase/app-check-compat",En="@firebase/app-check",xn="@firebase/auth",Tn="@firebase/auth-compat",Sn="@firebase/database",Cn="@firebase/database-compat",An="@firebase/functions",Rn="@firebase/functions-compat",In="@firebase/installations",Dn="@firebase/installations-compat",kn="@firebase/messaging",On="@firebase/messaging-compat",Nn="@firebase/performance",Un="@firebase/performance-compat",Pn="@firebase/remote-config",Bn="@firebase/remote-config-compat",Ln="@firebase/storage",Mn="@firebase/storage-compat",Hn="@firebase/firestore",Fn="@firebase/firestore-compat",$n="firebase",jn="9.23.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class se{constructor(e,s){this._service=e,s instanceof L?this._location=s:this._location=L.makeFromUrl(s,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,s){return new se(e,s)}get root(){const e=new L(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return Qt(this._location.path)}get storage(){return this._service}get parent(){const e=jr(this._location.path);if(e===null)return null;const s=new L(this._location.bucket,e);return new se(this._service,s)}_throwIfRoot(e){if(this._location.path==="")throw yr(e)}}function ai(t,e,s){return t._throwIfRoot("uploadBytesResumable"),new oi(t,new K(e),s)}function li(t){t._throwIfRoot("getDownloadURL");const e=Jr(t.storage,t._location,es());return t.storage.makeRequestWithTokens(e,oe).then(s=>{if(s===null)throw br();return s})}function ci(t,e){const s=zr(t._location.path,e),n=new L(t._location.bucket,s);return new se(t.storage,n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
