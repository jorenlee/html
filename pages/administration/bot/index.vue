        ...
        <ul class="w-full">
          <li class="w-full">
            ...
            <ul>
              ...
              <li class="">
                <a href="/administration/bot" class="whitespace-nowrap pr-2 items-center green-800-white px-2 py-1 font-bold flex border-b pl-5 hover:bg-green-800 text-green-800 hover:text-white text-xs cursor-pointer bg-gray-300">
                  <i class="fa fa-chevron-circle-right mr-2"></i>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span class="lg:w-4/12 lg:flex block lg:pr-3 lg:order-1 order-2"> {{ aa.officeAbbr }} </span> 
                </h1>
              </div>
            </div>
          </div>
