<script setup>
  ...
  },   
  {
    ...
    link: "/library/library-and-information-services-month",
  },
  {
    title: "Virtual Library Programs",
    link: "/library/virtual-programs",
  }, {
    title: "Library Gamification System",
    link: "/library/gamification-system",
  }, {
    title: "Library Personnel",
    link: "/library/library-personnel",
  }, 
    {
    title: "Webinars and Workshops",
    link: "/library/webinars-workshops",
  }, 
   {
    title: "Library Opening Hours",
    link: "/library/library-opening-hours",
  }, ];
  useHead({
    script: [{
          ...
          <div class="pt-2.5 pb-3 shadow-lg">
            <div class="w-11/12 mx-auto flex justify-between">
              ...
              <ul class="flex text-green-800 capitalize text-xs">
                <li>
                  <a href="/_/lib-admin" class="mr-1 flex items-center">
