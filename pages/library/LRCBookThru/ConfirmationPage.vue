...
<div class="bg-gray-50">
  ...
  <div class="">
    ...
    <div class="lg:flex gap-10 rounded-4xl bg-white lg:px-14 px-3 py-1 w-fit mx-auto lg:my-10 shadow-sm rounded-xl">
      ...
      <div class="text-xl text-green-900 text-center w-fit mx-auto lg:py-20 py-5">
        ...
        <a href="https://lsu.edu.ph/library"
          class="bg-green-800 text-white rounded-3xl py-1.5 px-10 lg:mb-0 mb-5 mx-auto block w-fit">Go Back to LRC</a>
      </div>
    </div>
  </div>
  <div></div>
