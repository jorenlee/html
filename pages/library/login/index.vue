    ...
    <div class="lg:h-screen flex items-center">
      <div class="lg:w-4/12 py-5 w-11/12 mx-auto">
        <div class="">
          ...
          <div
            class="py-7 px-4 lg:shadow-xl my-auto lg:order-1 order-2 text-center rounded-2xl"
          >
            <img
              class="lg:w-32 w-44 h-auto mx-auto block"
              src="https://raw.githubusercontent.com/jorenlee/lsu-public-images/main/images/images/logos/LSULRC.jpg"
            />
            <p class="text-2xl font-bold lasalle-green-text">LRC Book Thru</p>
            <button
              :disabled="!isReady"
              @click="() => login()"
              class="lg:w-fit w-10/12 pl-20 pr-10 py-3 bg-green-10 rounded-lg text-sm text-white text-center font-semibold login-with-google-btn block mx-auto uppercase lg:mt-7 mt-14 tracking-widest"
            >
              Login
            </button>
          </div>
