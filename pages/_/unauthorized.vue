      ...
      <div class="lg:w-4/12 py-5 w-11/12 mx-auto">
        <div class="">
          ...
          >
            ...
            <button
              @click="reLogin"
              class="lg:w-auto lg:whitespace-nowrap w-10/12 pl-12 pr-3 py-3 bg-green-10 rounded-lg text-sm text-white text-center font-semibold login-with-google-btn block mx-auto uppercase mt-7 tracking-widest"
            >
              <span class="mx-5">Sorry, Please Try Again!</span>
            </button>
          </div>
        </div>
      </div>
