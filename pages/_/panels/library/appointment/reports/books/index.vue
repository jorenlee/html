...
const goToEdit = (id) => {
  router.push("/_/panels/library/appointment/reports/books/edit/" + id);
};
    ...
    <div class="flex">
      ...
      <div class="w-full min-h-screen">
        ...
        <div class="w-full p-5">
          <div>
            <a href="/_/panels/library/appointment/reports/books/create" class="block w-fit bg-green-600 text-white font-bold px-3 py-2 mb-5 rounded-lg shadow hover:bg-green-700 text-xs">
             +  Add Record
            </a>
