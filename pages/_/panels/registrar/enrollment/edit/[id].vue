...
onMounted(() => {
  if (
    ...
    router.push("/_/panels/registrar/enrollment/edit/" + route.params.id);
...
const goToCreate = () => {
  router.push("/_/panels/registrar/create");
};

const goToSchedules = () => {
  router.push("/_/panels/registrar/set-schedules");
};

const goToEnrollment = () => {
  router.push("/_/panels/registrar/enrollment");
};
