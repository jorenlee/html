...
onMounted(() => {
  if (
    ...
    router.push("/_/panels/registrar/appointment/set-schedules/edit/" + route.params.id);
...
const editSchedule = async () => {
  ...
  .then((response) => {
    ...
    router.push({ path: "/_/panels/registrar/appointment/set-schedules" });
  });
};
</script>
            ...
            <div class="h-full shadow-lg pb-10">
              <div class="">
                <form class="w-full" v-on:submit.prevent="editSchedule">
                  ...
                  <NuxtLink to="/_/panels/registrar/appointment/set-schedules"
