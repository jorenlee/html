...
onMounted(() => {
  if (
    ...
    router.push("/_/panels/registrar/appointment/set-schedules");
  } else {
...
const goToList = () => {
  router.push("/_/panels/registrar/appointment");
};

const goToCreate = () => {
  router.push("/_/panels/registrar/appointment/create");
};
...
const addSchedules = () => {
  router.push("/_/panels/registrar/appointment/set-schedules/create");
};
...
const updateTimeAndProviders = (id) => {
  router.push("/_/panels/registrar/appointment/set-schedules/edit/" + id);
  // console.log(id);
};

const goToEdit = (id) => {
  router.push("/_/panels/registrar/appointment/edit/" + id);
};
</script>
