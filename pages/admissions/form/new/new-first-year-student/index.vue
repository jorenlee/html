<script setup>
  ...
  const newStudent = ref({
    ...
    new_student_placement_details: 'Placement (New First Year Student and Transferee)',
    new_student_placement_department: 'Career & Counseling Center',
    new_student_placement_test_administration_status: "-",
    new_student_placement_counselor_student_encounter_status: "-",
  ...
  if(
      ...
      newStudent.value.senior_highschool_track === null ||
      newStudent.value.senior_highschool_track === '' ||
      newStudent.value.senior_highschool_strand === null ||
      newStudent.value.senior_highschool_strand === '' ||
      newStudent.value.last_school_attended === null ||
      newStudent.value.last_school_attended === '' ||
      newStudent.value.shs_year_graduated === null ||
      newStudent.value.shs_year_graduated === ''
    ) {
  ...
  const seniorHighSchoolTrack = ref(['Academic', 'Arts and Design', 'Sports', 'TVL (Technical-Vocational-Livelihood)', 'Not Applicable'])
  const seniorHighSchoolStrand = ref(['ABM - Accountancy, Business and Management', 'AFA - Agricultural-Fishery Arts', 'GAS - General Academic Strand', 'HE - Home Economics', 'HUMSS - Humanities and Social Science', 'IA - Industrial Arts', 'ICT - Information and Communications Technology', 'STEM - Science, Technology, Engineering, and Mathematics', 'Not Applicable'])

  const suffixName = ref(['Jr.', 'Sr.', 'I', 'II', 'III', 'IV', 'N/A'])
  const shsYearGraduated = ref([
    'A.Y. 2018 to 2019', 
    'A.Y. 2019 to 2020', 
    'A.Y. 2020 to 2021', 
    'A.Y. 2021 to 2022',
  ...
  const city_municipalityList = ref([
    'list',
  ])
  const province_stateList = ref([
    'list',
  ])
  ...
  const submitToAPI = async () => {
    await $fetch(endpoint.value + "/api/admissions-second-sem-dev/new-student/create/", {
      method: "POST",
      headers: {
            ...
            <div class="mt-3 w-full">
              ...
              <div>
                <form v-on:submit.prevent="submitForm">
                  <div class="border-t-2 border-green-700 mt-5 shadow-lg mb-5" v-show="toggle.one">
                    <div>
                            ...
                            <div class="flex gap-3">
                              <div class="w-full">
                                <div class="lg:flex w-full gap-3">
                                  <div class="lg:flex gap-3 w-full">
                                    <div class="w-full lg:mb-0 mb-3">
                                      <label class="lg:text-xs text-[10px] text-gray-900 lg:block  pb-1">
                                        Last Name</label>
                                      <input type="text" 
                                        class="px-2 w-full capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 lg:text-xs text-[10px]" 
                                        placeholder="Last Name" 
                                        v-model="newStudent.lastname" />
                                    </div>
                                    <div class="w-full lg:mb-0 mb-3">
                                      <label class="lg:text-xs text-[10px] text-gray-900 lg:block pb-1">First Name</label>
                                      <input type="text" class="px-2 w-full capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 lg:text-xs text-[10px]" 
                                  ...
                                  <div class="flex gap-3 lg:mb-0 mb-3">
                                    <div class="w-6/12">
                                      <label class="lg:text-xs text-[10px] text-gray-900 lg:block  pb-1"> 
                                        Suffix Name </label>
                                      <div class="flex">
                                        <select class="lg:w-24 w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 lg:text-xs text-[10px]" 
                                    ...
                                    <div class="w-full">
                                      <label class="lg:text-xs text-[10px] text-gray-900 lg:block pb-1"> 
                                        Birth Sex </label>
                                      <div class="flex lg:w-fit gap-5 pt-2.5 lg:pb-[8.5px] pb-[9.5px] lg:pl-4 pl-3 lg:pr-5 shadow bg-white border-b-2 border-green-700">
                                        <div class="flex mr-3">
                                          <input type="radio" 
                                            value="Female" 
                                   ...
                                   <div class="flex gap-3">
                                    <div class="w-full">
                                      ...
                                      <div>
                                        <input type="date" 
                                          class="lg:w-44 px-2 w-full border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 lg:text-xs text-[10px]" 
                                    ...
                                    <div class="w-full lg:flex gap-3 grid lg:grid-cols-2">
                                      <div>
                                        ...
                                        <div>
                                          <select class="lg:w-32 w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 lg:text-xs text-[10px]" 
                        ...
                        <div class="mt-3 lg:pb-5 pb-3 lg:px-5 px-2">
                          <div class="lg:flex gap-3">
                            ...
                            <div class="w-full lg:mb-0 mb-3"
                              ...
                              <div>
                                <input type="email" 
                                  class="w-full lg:text-xs text-[10px] px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9" 
                             ...
                             <div class="lg:mb-0 mb-3">
                              ...
                              <div class="flex justify-center lg:w-auto lg:gap-5 pt-2.5 pb-2 lg:pl-4 pr-1 pl-3 shadow bg-green-100 border-b-2 border-green-700 w-full">
                                <div class="flex mr-3">
                                  <input type="radio"
                                     value="yes" 
                            ...
                            <div class="lg:mb-0 mb-3" 
                              ...
                              <div class="flex">
                                <input type="text" class="lg:w-[120px] w-full lg:text-xs text-[10px] px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9" 
                            ...
                            <div class="lg:mb-0 mb-3" 
                              ...
                              <div class="flex">
                                <input type="text" 
                                value="N/A"
                                class="lg:w-[70px] w-full bg-gray-100 lg:text-xs text-[10px] border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-center" 
                                 disabled/>
                              </div>
                            </div>
                          </div>
                           ...
                           <div class="w-full flex gap-3">
                            <div class="w-full lg:mb-0 mb-3">
                              ...
                              <div>
                                <input type="text" 
                                  disabled 
                                  class="w-full lg:text-xs text-[10px] bg-gray-100 px-3 border-b-2 border-t-0 border-x-0  shadow-lg rounded-sm h-9" 
                            ...
                            <div class="w-full lg:mb-0">
                              ...
                              <select v-model="courseSelection" @change="assignCollege"
                                class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm text-black h-9 lg:text-xs text-[10px]" required>
                      ...
                      <div class="lg:px-5 px-2 lg:flex border-b-4 lg:pt-6 pt-3 pb-3 gap-3">
                        <div class="lg:flex gap-3 mb-5 w-full">
                          <div class="w-full lg:mb-0 mb-5">
                            <label class="lg:font-bold lg:text-xs text-[10px] text-black w-fit whitespace-nowrap pr-10 pb-1 block"> Senior Highschool Track </label>
                            <div>
                              <select class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 lg:text-xs text-[10px]" 
                              v-model="newStudent.senior_highschool_track">
                                <option value="" disabled selected> Senior Highschool Track </option>
                                <option :value="j" v-for="(j, i) in seniorHighSchoolTrack" :key="i">{{ j }}
                                </option>
                              </select>
                            </div>
                          </div>
                          <div class=" w-full lg:mb-0 mb-5">
                            <label class="lg:font-bold lg:text-xs text-[10px] text-black w-fit whitespace-nowrap pr-10 pb-1 block"> Senior Highschool Strand </label>
                            <div>
                              <select class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 lg:text-xs text-[10px]" 
                              v-model="newStudent.senior_highschool_strand">
                                <option value="" disabled selected> Senior Highschool Strand </option>
                                <option :value="j" v-for="(j, i) in seniorHighSchoolStrand" :key="i">{{ j }}
                                </option>
                              </select>
                            </div>
                          </div>
                        ...
                        <div class="lg:flex gap-3 w-full">
                          <div class=" w-full lg:mb-0 mb-5">
                            <label class="lg:font-bold lg:text-xs text-[10px] text-black w-fit whitespace-nowrap pr-10 pb-1 block"> Last School Attended </label>
                            <input type="text" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 lg:text-xs text-[10px]" placeholder="Last School Attended" 
                            v-model="newStudent.last_school_attended"/>
                          </div>
                          <div class="lg:w-4/12 w-full lg:mb-0 mb-2">
                            <label class="lg:font-bold lg:text-xs text-[10px] text-black w-fit whitespace-nowrap pr-10 pb-1 block"> SHS Year Graduated </label>
                            <div>
                              <select class="w-full px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 lg:text-xs text-[10px]" 
                              v-model="newStudent.shs_year_graduated">
                                <option value="" disabled selected > SHS Year Graduated </option>
                                <option :value="j" v-for="(j, i) in shsYearGraduated" :key="i">{{ j }}
                                </option>
                              </select>
                            </div>
                          </div>
                      ...
                      <div class="pb-5">
                                ...
                                <div class="mb-3 w-full">
                                  <div class="lg:flex w-full gap-3">
                                    <div class="lg:flex gap-3 w-full lg:mb-0 mb-3">
                                      <div class="w-fit">
                                        <label class="lg:text-xs text-[10px] text-gray-900 block  pb-1">Title</label>
                                    ...
                                    <div class="lg:flex gap-3">
                                      ...
                                      <div>
                                        <label class="lg:text-xs text-[10px] text-gray-900 lg:block  pb-1"> Birth Date </label>
                                        <div>
                              ...
                              <div class="flex gap-3">
                                <div class="w-full">
                                  <div class="lg:flex w-full gap-3">
                                    <div class="lg:flex gap-3 w-full">
                                      <div>
                                        <label class="lg:text-xs text-[10px] text-gray-900 lg:block  pb-1"> Birth Order </label>
                                        <div>
                                      ...
                                      <div class="w-full">
                                        <label class="lg:text-xs text-[10px] text-gray-900 lg:block  pb-1">Birth Place</label>
                                        <div>
                                      ...
                                      <div>
                                        <label class="lg:text-xs text-[10px] text-gray-900 lg:block  pb-1"> Civil Status </label>
                                        <div>
                                      ...
                                      <div>
                                        <label class="lg:text-xs text-[10px] text-gray-900 lg:block  pb-1">Ethnicity</label>
                                        <div>
                        ...
                        <div class="">
                          ...
                          <div class="lg:flex gap-3">
                            <div class="flex w-full gap-3">
                              <div class="w-full lg:mb-0 mb-3">
                                <label class="lg:text-xs text-[10px] text-gray-900 lg:block  pb-1"> Primary Contact Number</label>
                                <div>
                              ...
                              <div class="w-full lg:mb-0 mb-3">
                                <label class="lg:text-xs text-[10px] text-gray-900 lg:block  pb-1"> Alternate Contact Number</label>
                                <div>
                            ...
                            <div class="w-full lg:mb-0 mb-3">
                              <label class="text-xs text-gray-900 lg:block  pb-1"> Personal Email Address </label>
                              <div>
                            ...
                            <div class="lg:mb-0 mb-3">
                              <label class="lg:text-xs text-[10px] text-gray-900 lg:block  pb-1 whitespace-nowrap"> Are you a former student of LSU-Ozamiz? <span class="text-red-600">*</span></label>
                  ...
                  <div class="border-t-2 border-green-700 mt-5 shadow-lg mb-5" v-show="toggle.three">
                    <div>
                  ...
                  <div class="border-t-2 border-green-700 mt-5 shadow-lg mb-5" v-show="toggle.four">
                    <div>
                  ...
                  <div class="border-t-2 border-green-700 mt-5 shadow-lg mb-5" v-show="toggle.five">
                    <div>
