<script setup>
  ...
  const newStudent = ref({
    ...
    transferee_student_college: "N/A",
    transferee_student_program: "N/A",
    transferee_student_placement_details: 'Placement and Course Crediting (Transferee)',
    transferee_student_placement_department: 'Career & Counseling Center',
    transferee_student_placement_test_administration_status: "N/A",
    transferee_student_placement_counselor_student_encounter_status: "N/A",
    transferee_student_placement_accepting_college: "N/A",
    transferee_student_placement_approval_status: "N/A",
    credential_student_portal_username: "N/A",
    credential_student_portal_password: "N/A",
    credential_student_lsu_email_username: "N/A",
    credential_student_lsu_email_password: "N/A",
    credential_student_canvas_username: "N/A",
    credential_student_canvas_password: "N/A" 
  ...
  if(
      ...
      newStudent.value.transferee_student_college === null ||
      newStudent.value.transferee_student_program === ''
    ) {
  ...
  const courseSelectionTransferee = ref('Select Course Program');
  ...
  const assignCollegeTransferee = () => {
    newStudent.value.transferee_student_college = courseSelectionTransferee.value.college
    newStudent.value.transferee_student_program = courseSelectionTransferee.value.program
  }
  const assignCollege = () => {
  ...
  const submitToAPI = async () => {
    await $fetch(endpoint.value + "/api/admissions-second-sem-dev/transferee/create/", {
      method: "POST",
      headers: {
                                ...
                                <div class="lg:flex w-full gap-3">
                                  <div class="lg:flex gap-3 w-full lg:mb-0 mb-3">
                                    <div class="w-full">
                                      <label class="lg:text-xs text-[10px] text-gray-900 lg:block  pb-1">
                                        Last Name</label>
                                      <input type="text" 
                                        class="px-2 w-full capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" 
                                        placeholder="Last Name" 
                                        v-model="newStudent.lastname" />
                                    </div>
                                    <div class="w-full">
                                      <label class="lg:text-xs text-[10px] text-gray-900 lg:block pb-1">First Name</label>
                                      <input type="text" class="px-2 w-full capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" 
                                  ...
                                  <div class="flex gap-3">
                                    ...
                                    <div class="w-full">
                                      <label class="lg:text-xs text-[10px] text-gray-900 lg:block pb-1"> 
                                        Birth Sex </label>
                                      <div class="flex lg:w-fit gap-5 pt-2.5 pb-[8.5px] lg:pl-4 pl-3 lg:pr-5 shadow bg-white border-b-2 border-green-700">
                                        <div class="flex mr-3">
                                          <input type="radio" 
                                            value="Female" 
                        ...
                        <div class="mt-3 lg:pb-5 pb-3 lg:px-5 px-2">
                          <div class="lg:flex gap-3">
                            ...
                            <div class="lg:mb-0 mb-3" 
                              ...
                              <div class="flex">
                                <input type="text" 
                                value="N/A"
                                class="lg:w-[70px] w-full bg-gray-100 text-xs border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-center" 
                                 disabled/>
                              </div>
                            </div>
                          ...
                          <div class="lg:flex gap-3 mt-5 border-t-4 pb-3 border-gray lg:pt-6 pt-3">
                            ...
                            <div class="w-full mx-auto lg:mb-0 mb-3">
                              ...
                              <select v-model="courseSelection" @change="assignCollege" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm text-black h-9 text-xs" required>
                            ...
                            <div class="w-full mx-auto lg:mb-0">
                              <label class="lg:text-xs text-[10px] mb-1 text-black lg:block lg:font-bold"> Previous Degree Program </label>
                              <select v-model="courseSelectionTransferee" @change="assignCollegeTransferee" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm text-black h-9 text-xs">
                        ...
                        <div class="lg:px-5 px-2 mb-5">
                          <div class="lg:flex pt-3 gap-3">
                            <div class="lg:w-6/12 lg:mb-0 mb-3">
                              <label class="lg:font-bold lg:text-xs text-[10px] text-black w-fit whitespace-nowrap pr-10 pb-1 block"> Last Term Enrolled </label>
                              <div>
