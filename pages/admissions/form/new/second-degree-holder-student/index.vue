<script setup>
   ...
   import programOnlyJSON from "../../backup/courseProgramOnlyNewStudents.json";
   ...
   const newStudent = ref({
     ...
     second_degree_holder_student_college: "-",
     second_degree_holder_student_program: "-",
   ...
   const firstNext = () => {
   if(
       newStudent.value.former_lsu_student === null ||
       newStudent.value.former_lsu_student === '' ||
       ...
       newStudent.value.last_school_graduated === null ||
       newStudent.value.last_school_graduated === '' ||
       newStudent.value.last_term_graduated === null ||
       newStudent.value.last_term_graduated === '' ||
       newStudent.value.last_academic_year_graduated === null ||
       newStudent.value.last_academic_year_graduated === '' ||
       newStudent.value.second_degree_holder_student_college === null ||
       newStudent.value.second_degree_holder_student_college === '' ||
       newStudent.value.second_degree_holder_student_program === null ||
       newStudent.value.second_degree_holder_student_program === ''
     ) {
     ...
     else if(newStudent.value.former_lsu_student === 'yes'
   ...
   const courseSelectionSecondDegree = ref('Select Course Program');
   ...
   const lastTermGraduated = ref([
     '1st Semester', 
     '2nd Semester',
     'Summer'
   ])
   const lastAcademicYearGraduated = ref([
     'A.Y. 2010 to 2011', 
     'A.Y. 2011 to 2012', 
     'A.Y. 2012 to 2013', 
     'A.Y. 2013 to 2014',
   ...
   let assignCollegeSecondCourser = () => {
     newStudent.value.second_degree_holder_student_college = courseSelectionSecondDegree.value.college
     newStudent.value.second_degree_holder_student_program = courseSelectionSecondDegree.value.program
   }
   let assignCollege = () => {
   ...
   const submitToAPI = async () => {
     await $fetch(endpoint.value + "/api/admissions-second-sem-dev/second-degree-holder/create/", {
       method: "POST",
       headers: {
         ...
         <div>
            <div class="w-11/12 mx-auto shadow lg:px-8 px-3 lg:py-7 py-2 lg:mt-10 mt-3 lg:mb-3">
               <h1 class="font-bold lg:text-2xl text-xs text-green-800 text-center"> 
                  APPLICATION FOR UNDERGRADUATE STUDENTS : Second Degree Holder Status 
               </h1>
                  ...
                  <div class="mt-3 w-full">
                     ...
                     <div>
                        <form v-on:submit.prevent="submitForm">
                           <div class="border-t-2 border-green-700 mt-5 lg:mb-0 mb-5 shadow-lg" v-show="toggle.one">
                              <div>
                                 ...
                                 <div class="border-y-4">
                                    ...
                                    <div class="mt-3 lg:pb-5 pb-2 lg:px-5 px-2">
                                       <div>
                                          <div class="lg:flex gap-3">
                                             <div class="mb-3 w-full">
                                                <div class="lg:flex w-full gap-3">
                                                   <div class="lg:flex gap-3 w-full lg:mb-0 mb-1">
                                                      <div class="w-full">
                                                         <label class="lg:text-xs text-[10px] text-gray-900 lg:block  pb-1">Last Name</label>
                                                         <input type="text" class="w-full capitalize px-2 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" placeholder="Last Name" v-model="newStudent.lastname" />
                                                      </div>
                                                      <div class="w-full">
                                                         <label class="lg:text-xs text-[10px] text-gray-900 lg:block  pb-1">First Name</label>
                                                         <input type="text" class="w-full capitalize px-2 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" placeholder="First Name" v-model="newStudent.firstname" />
                                                      </div>
                                                      <div class="w-full">
                                                         <label class="lg:text-xs text-[10px] text-gray-900 lg:block  pb-1">Middle Name</label>
                                                         <input type="text" class="w-full capitalize px-2 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" placeholder="Middle Name" v-model="newStudent.middlename" />
                                                      </div>
                                                   </div>
                                                   <div class="lg:flex gap-3">
                                                      <div class="flex gap-3">
                                                         ...
                                                         <div class="w-full">
                                                            <label class="lg:text-xs text-[10px] text-gray-900 lg:block pb-1"> 
                                                            Birth Sex </label>
                                                            <div class="flex lg:w-fit gap-5 lg:pt-[10px] pt-[10.5px] pb-[8.5px] lg:pl-4 pl-3 lg:pr-5 shadow-lg bg-white border-b-2 border-green-700">
                                                               <div class="flex mr-3">
                                                                  <input type="radio" 
                                                                     value="Female" 
                                       ...
                                       <div class="lg:flex gap-3">
                                          <div class="flex w-full gap-3">
                                             <div class="w-full lg:mb-0 mb-2">
                                                ...
                                                <div>
                                                   <input type="text" class="w-full text-xs lg:px-3 px-2 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9" 
                                          ...
                                          <div class="w-full lg:mb-0 mb-2">
                                             <label class="lg:text-xs text-[10px] text-gray-900 lg:block  pb-1"> Personal Email Address </label>
                                             <div>
                                                <input type="email" class="w-full text-xs lg:px-3 px-2 border-b-2 border-t-0 border-x-0 
                                                border-green-700 shadow-lg rounded-sm h-9" placeholder="e.g name7@gmail.com" 
                                                v-model="newStudent.contact_personal_email_address" required />
                                             </div>
                                          </div>
                                          <div class="w-full lg:mb-0 mb-2" v-if="newStudent.former_lsu_student === 'yes'">
                                             <label class="lg:text-xs text-[10px] text-gray-900 lg:block  pb-1"> LSU Email</label>
                                             <div>
                                                <input type="email" class="w-full text-xs lg:px-3 px-2 border-b-2 border-t-0 border-x-0 
                                                border-green-700 shadow-lg rounded-sm h-9" placeholder="e.g firstname.lastname@lsu.edu.ph" 
                                                v-model="newStudent.contact_lsu_email_address" />
                                             </div>
                                          </div>
                                          <div class="lg:mb-0 mb-2">
                                             <label class="lg:text-xs text-[10px] text-gray-900 lg:block  pb-1 whitespace-nowrap"> 
                                             Are you a former student of LSU-Ozamiz? 
                                             <span class="text-red-600">*</span>
                                             </label>
                                             <div class="flex justify-center lg:w-auto lg:gap-5 pt-2.5 pb-[8.5px] lg:pl-4 pr-1 pl-3 
                                             shadow bg-green-100 border-b-2 border-green-700 w-full">
                                                <div class="flex mr-3">
                                                   <input type="radio"
                                                      value="yes" 
                                                      v-model="newStudent.former_lsu_student" 
                                                      class="lg:mr-2 mr-1" />
                                                   <label class="lg:text-xs text-[10px]"> Yes </label>
                                                </div>
                                                <div class="flex">
                                                   <input type="radio" 
                                                      value="no" 
                                                      v-model="newStudent.former_lsu_student" 
                                                      class="lg:mr-2 mr-1" />
                                                   <label class="lg:text-xs text-[10px] pr-3"> No </label>
                                                </div>
                                             </div>
                                          </div>
                                          <div class="lg:mb-0 mb-2" 
                                             ...
                                             <div class="flex">
                                                <input type="text" class="lg:w-[120px] w-full text-xs px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9" 
                                             ...
                                             <div v-if="infoText" 
                                                class="text-green-900 lg:text-xs text-[10px] mt-3 leading-tight min-w-[250px]"> 
                                                Enter your ID number as registered on your account or as shown on your Student ID Card 
                                             </div>
                                          </div>
                                          <div class="lg:mb-0 mb-2" 
                                             v-if="newStudent.former_lsu_student === 'no'">
                                             <div class="flex items-center">
                                                <label class="lg:text-xs text-[10px] text-gray-900 lg:block  pb-1"> LSU Student ID </label>
                                             </div>
                                             <div class="flex">
                                                <input type="text" 
                                                   value="N/A"
                                                   class="lg:w-[70px] w-full bg-gray-100 text-xs border-b-2 border-t-0 border-x-0 
                                                   border-green-700 shadow-lg rounded-sm h-9 text-center" 
                                                   disabled/>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="lg:flex gap-3 lg:mt-5 mt-4 pb-2 border-gray pt-2 border-t-4">
                                          <div class="lg:w-4/12 flex gap-3">
                                          ...
                                          <div class="lg:w-4/12 lg:mb-0 mb-2">
                                             ...
                                             <select v-model="courseSelection" @change="assignCollege" class="w-full px-3 capitalize 
                                             border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm text-black h-9 text-xs" required>
                                          ...
                                          <div class="lg:w-4/12 lg:mb-0">
                                             <label class="lg:text-xs text-[10px] mb-1 text-black lg:block  capitalize lg:font-bold"> previous Degree program graduated </label>
                                             <select v-model="courseSelectionSecondDegree" @change="assignCollegeSecondCourser" 
                                                class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 
                                 ...
                                 <div class="border-b-4 py-2">
                                    <div class="lg:px-5 px-2 lg:mb-5 mb-3">
                                       <div class="lg:flex lg:pt-3 gap-3">
                                          <div class="lg:mb-0 mb-3 lg:w-5/12 lg:mt-0 mt-1">
                                             <label class="lg:font-bold lg:text-xs text-[10px] text-black w-fit whitespace-nowrap pr-10 pb-1 block"> Last Term Graduated </label>
                                             <div>
                                                <select v-model="newStudent.last_term_graduated" class="w-full px-3 capitalize border-b-2 
                                                border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs">
                                                   <option value="" disabled selected hidden> Last Term Graduated </option>
                                                   <option :value="j" v-for="(j, i) in lastTermGraduated" :key="i">{{ j }}
                                                   </option>
                                                </select>
                                             </div>
                                          </div>
                                          <div class="lg:mb-0 mb-3 lg:w-5/12">
                                             <label class="flex lg:font-bold lg:text-xs text-[10px] text-black w-fit whitespace-nowrap pr-10 pb-1">
                                             <span>Last Academic Year Graduated</span>
                                             </label>
                                             <select v-model="newStudent.last_academic_year_graduated" class="w-full px-3 border-b-2 
                                             border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs">
                                                <option value="" disabled selected hidden>Last Academic Year Graduated</option>
                                                <option :value="j" v-for="(j, i) in lastAcademicYearGraduated" :key="i">{{ j }}
                                                </option>
                                             </select>
                                          </div>
                                          <div class="w-full">
                                             <label class="lg:font-bold lg:text-xs text-[10px] text-black w-fit whitespace-nowrap pr-10 pb-1 block"> Last School Graduated </label>
                                             <input v-model="newStudent.last_school_graduated" type="text" class="w-full px-3 capitalize 
                                             border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" placeholder="Last School Graduated" />
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="border-b-4" v-if="newStudent.citizenship === 'non-filipino'">
                                    ...
                                    :class="studentAlienStatusInformationToggle ? 'bg-white text-green-900 border-b-4 border-green-800' : 'bg-green-600 text-white'">
                                       <p class="uppercase font-bold lg:text-xs text-[10px]"> Alien status information </p>
                                       <span>
                                    ...
                                    <div class="mt-3 pb-5 px-10" v-if="studentAlienStatusInformationToggle">
                                       <div class="lg:flex grid grid-cols-2 gap-3 mb-2">
                                          <div class="w-full">
                                             <label class="lg:text-xs text-[10px] text-black"> Citizenship</label>
                                             ...
                                             v-model="newStudent.alien_status_information.citizenship" placeholder="Citizenship" />
                                          </div>
                                          <div class="w-full">
                                             <label class="lg:text-xs text-[10px] text-black"> Visa Status </label>
                                             <input type="text" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" 
                                             v-model="newStudent.alien_status_information.visa_status" placeholder="Visa Status" />
                                          </div>
                                          <div class="w-full">
                                             <label class="lg:text-xs text-[10px] text-black"> Last Day Authorized Stay </label>
                                             <input type="text" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" 
                                             v-model="newStudent.alien_status_information.last_day_of_authorized_stay" placeholder="Last Day of Authorized Stay" />
                                          </div>
                                          <div class="w-full">
                                             <label class="lg:text-xs text-[10px] text-black"> Agent Name </label>
                                             <input type="text" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" 
                                             v-model="newStudent.alien_status_information.agent_name" placeholder="Agent Name" />
                                          </div>
                                       </div>
                                       <div class="lg:flex grid grid-cols-2 gap-3 mb-2">
                                          <div class="w-full">
                                             <label class="lg:text-xs text-[10px] text-black"> Passport Number </label>
                                             <input type="text" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" 
                                             v-model="newStudent.alien_status_information.passport_number" placeholder="Passport Number" />
                                          </div>
                                          <div class="w-full">
                                             <label class="lg:text-xs text-[10px] text-black"> Passport: Place Issued </label>
                                             <input type="text" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" 
                                             v-model="newStudent.alien_status_information.passport_place_issued" placeholder="Passport: Place Issued" />
                                          </div>
                                          <div class="w-full">
                                             <label class="lg:text-xs text-[10px] text-black"> Passport: Date Issued </label>
                                             <input type="date" class="w-full px-3 uppercase border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" 
                                             v-model="newStudent.alien_status_information.passport_date_issued" placeholder="Passport: Date Issued" />
                                          </div>
                                          <div class="w-full">
                                             <label class="lg:text-xs text-[10px] text-black"> Passport: Date of Expiry </label>
                                             <input type="date" class="w-full px-3 uppercase border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" 
                                             v-model="newStudent.alien_status_information.passport_date_of_expiry" placeholder="Passport: Date of Expiry" />
                                          </div>
                                       </div>
                                       <div class="lg:flex grid grid-cols-2 gap-2">
                                          <div class="w-full">
                                             <label class="lg:text-xs text-[10px] text-black"> ACR: I-CARD: Date Issued </label>
                                             <input type="date" class="w-full px-3 uppercase border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" 
                                             v-model="newStudent.alien_status_information.acricard_date_issued" placeholder="ACRICARD Date Issued" />
                                          </div>
                                          <div class="w-full">
                                             <label class="lg:text-xs text-[10px] text-black"> ACR: I-CARD: Expiry Date </label>
                                             <input type="date" class="w-full px-3 uppercase border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" 
                                             v-model="newStudent.alien_status_information.acricard_date_of_expiry" placeholder="ACRICARD Date of Expiry" />
                                          </div>
                                          <div class="w-full">
                                             <label class="lg:text-xs text-[10px] text-black"> CRTS: Date Issued </label>
                                             <input type="date" class="w-full px-3 uppercase border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" 
                                             v-model="newStudent.alien_status_information.crts_date_issued" placeholder="CRTS Date Issued" />
                                          </div>
                                          <div class="w-full">
                                             <label class="lg:text-xs text-[10px] text-black"> CRTS: Date of Expiry </label>
                                             <input type="date" class="w-full px-3 uppercase border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" 
                                             v-model="newStudent.alien_status_information.crts_date_of_expiry" placeholder="CRTS Date of Expiry" />
                                          </div>
                                          <div class="w-full">
                                             <label class="lg:text-xs text-[10px] text-black"> SSP: Date Issued </label>
                                             <input type="date" class="w-full px-3 uppercase border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" 
                                             v-model="newStudent.alien_status_information.ssp_date_issued" placeholder="SSP Date Issued" />
                                          </div>
                                          <div class="w-full">
                                             <label class="lg:text-xs text-[10px] text-black"> SSP: Date of Expiry </label>
                                             <input type="date" class="w-full px-3 uppercase border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" 
                                             v-model="newStudent.alien_status_information.ssp_date_of_expiry" placeholder="SSP Date of Expiry" />
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div v-if="requiredFields" class="my-10 text-white bg-red-500 font-bold text-center py-1 px-5 block lg:text-sm text-xs"> 
                                    Must complete all information. Otherwise, type N/A if not applicable. 
                                 </div>
                              </div>
                           </div>
                                          ...
                                          <div class="lg:flex gap-3">
                                             ...
                                             <div class="lg:mb-0 mb-3" v-if="newStudent.former_lsu_student === 'yes'">
                                                ...
                                                <div class="flex">
                                                   ...
                                                   <span @click="infoText = !infoText" class="text-center cursor-pointer bg-green-800 font-bold border border-green-900 text-white rounded-full px-1.5 h-5 w-5 ml-3 mt-2">
                                                   <i class="fa fa-question mt-0.5 -ml-[1px] flex"></i>
                                                   </span>
                                                </div>
                                       ...
                                       <div class="border-b-4">
                                          <div class="lg:flex lg:w-9/12 w-11/12 mx-auto gap-40 lg:pb-0 pb-3">
                                             ...
                                             <div class="w-full lg:py-5 pt-3">
                                                <div class="">
                                                   <p class="font-bold text-md text-green-900 mb-2">
                                                      {{ newStudentFull.reasons_for_choosing_lsu.question }}
                                                   </p>
                                                   <ul class="lg:ml-2">
                           ...
                           <div class="border-t-2 border-green-700 mt-5 lg:mb-0 mb-5 shadow-lg" v-show="toggle.three">
                              <div>
                           ...
                           <div class="border-t-2 border-green-700 mt-5 lg:mb-0 mb-5 shadow-lg" v-show="toggle.four">
                              <div>
                           ...
                           <div class="border-t-2 border-green-700 mt-5 lg:mb-0 mb-5 shadow-lg" v-show="toggle.five">
                              <div>
