...
const newStudent = ref({
    ...
    receipt: {
        image_url: "https://st2.depositphotos.com/4202565/10481/v/450/depositphotos_104815098-stock-illustration-white-blank-receipt.jpg",
        submitted: false,
        confirm: false,
    },
    evaluation: {
...
const vitalLifeStatusSelection = () => {
    if (newStudent.value.father_personal_info.vital_life_status === 'living') {
        fatherInfo.value = true;
    }
    if (newStudent.value.father_personal_info.vital_life_status === 'deceased') {
        fatherInfo.value = false;
    }
    if (newStudent.value.mother_personal_info.vital_life_status === 'living') {
        motherInfo.value = true;
    }
    if (newStudent.value.mother_personal_info.vital_life_status === 'deceased') {
                                    ...
                                    <div>
                                        ...
                                        <div class="border-b-4">
                                            ...
                                            <div @click="studentContactInformationToggle = !studentContactInformationToggle"
                                                ...
                                                <span>
                                                    <i class="fa text-2xl"
                                                        :class="studentContactInformationToggle ? 'fa-caret-up' : 'fa-caret-down'"></i>
                                                </span>
                                            </div>
                                    ...
                                    <div>
                                        <div class="parents lg:flex">
                                            <div class="border-b-4 lg:px-10 px-3 py-5 lg:w-4/12 w-full">
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="py-5" v-if="fatherInfo">
                                                        <p class="lg:mb-3 mb-2 font-bold text-green-800">Contact Details
                                                        </p>
                                                        <div class="">
                                                            <div>
                                                                <label
                                                    ...
                                                    <div class="py-5" v-if="fatherInfo">
                                                        <p class="lg:mb-3 mb-2 font-bold text-green-800">Employment
                                                            Details</p>
                                            ...
                                            <div class="border-b-4 lg:px-10 px-3 py-5 lg:w-4/12 w-full">
                                                ...
                                                <div class="">
                                                    <div class="py-5">
                                                        <p class="lg:mb-3 mb-2 font-bold text-green-800">Personal
                                                            Details</p>
                                                        <div class="lg:grid lg:grid-cols-3 gap-3">
                                                            <div>
                                                                <label
                                        ...
                                        <div class="guardian">
                                            <div class="border-b-4 lg:px-10 px-3 py-5">
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="py-5">
                                                        <p class="mb-2 font-bold text-green-800">Contact Details</p>
                                                        <div class="">
                                                            <div class="mb-5">
                                                                <label
                                                                    class="text-[10px] text-gray-300 lg:block hidden">
                                                                ...
                                                                <div class="lg:grid grid-cols-7 gap-3">
                                                                    <input type="text"
                                                                        class="w-full px-3 border-b-2 border-t-0 border-x-0 
                                                                        border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                ...
                                <div class="mx-auto border-t-2 border-green-700 mt-5 shadow-lg rounded-lg pt-5"
                                    ...
                                    <div>
                                        <div class="border-b-4 lg:px-5 pb-3">
                                            ...
                                            <div class="shadow py-2 px-4 mt-4 bg-green-100">
