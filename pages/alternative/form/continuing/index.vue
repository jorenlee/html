<script setup>
  ...
  let newStudent = ref({
    ...
    receipt_confirm: 'no',
    shiftee_placement: {
      details: 'Placement (Career re-assessment for Shiftee)',
  ...
  const courseSelectionShiftee = ref();
  ...
  const submitToAPI = async () => {
    await $fetch(endpoint.value + "/api/admissions-first-sem/create/", {
      method: "POST",
      headers: {
  ...
  let assignCollegeShiftee = () => {
    newStudent.value.shiftee_student.college = courseSelectionShiftee.value.college || ''
    newStudent.value.shiftee_student.program = courseSelectionShiftee.value.program || ''
  }
  ...
  const submitFunc = () => {
    ...
    if (newStudent.value.shiftee_student.is_student_shiftee === 'yes') {
      newStudent.value.tracking_id = "TIDSS" + moment().valueOf()
      primaryInfo()
      assignCollegeShiftee()
      submitToAPI();
      // console.log(newStudent.value)
    } else if (newStudent.value.returnee_student.is_student_returnee === 'yes') {
      newStudent.value.tracking_id = "TIDR" + moment().valueOf()
      primaryInfo()
      // console.log(newStudent.value)
      submitToAPI();
    } 
    else if (newStudent.value.returnee_student.is_student_returnee === 'yes' && newStudent.value.shiftee_student.is_student_shiftee === 'yes') {
                    ...
                    <div>
                                ...
                                <div class="lg:flex w-full gap-3">
                                  ...
                                  <div class="lg:flex gap-3">
                                      <div>
                                        ...
                                        <div class="flex">
                                          <input type="text" class="lg:w-20 w-full capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" 
                                          v-model="newStudent.extension_or_suffix_name" placeholder="Suffix" />
                                        </div>
                                      </div>
                                      <div class="">
                                      ...
                                      <div>
                                        ...
                                        <div>
                                          <input type="date" class="lg:w-44 w-full border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" placeholder="Date of Birth" 
                      ...
                      <div class="border-b-4">
                        ...
                        <div class="mt-3 lg:pb-5 pb-3 lg:px-5 px-2">
                          <div class="lg:flex gap-3">
                            ...
                            <div class="w-full lg:mb-0 mb-3">
                              ...
                              <div class="flex items-center rounded-sm w-full">
                                ...
                                <input type="email" class="w-full text-xs px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9" placeholder="e.g firstname.lastname@lsu.edu.ph" 
                                v-model="newStudent.contact_lsu_email_address" />
                              </div>
                            </div>
                            <div class="lg:mb-0 mb-3">
                              ...
                              <div class="flex">
                                <input type="text" class="w-[120px] text-xs px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9" placeholder="e.g 221123265" v-model="newStudent.student_lsu_id_number" />
                          ...
                          <div class="lg:flex gap-3 mt-5 border-t-4 pt-5 lg:pb-6 border-gray">
                            ...
                            <!-- {{courseSelection}} -->
                            <!-- {{courseSelection.college}}
                            {{courseSelection.program}} -->
                            <!-- <span class="border border-black"> {{ newStudent.college }}</span> -->
                            <!-- {{ newStudent.program }} -->
                            <!-- <div @click="assignCollege">click me</div> -->
                            <!-- <div @click="assignCollegeShiftee">click me</div> -->
                          </div>
                        </div>
                      </div>
                      <div class="border-b-4" v-if="newStudent.citizenship === 'non-filipino'">
                        <div @click="studentAlienStatusInformationToggle = !studentAlienStatusInformationToggle" class="flex justify-center px-5 items-center cursor-pointer" :class="studentAlienStatusInformationToggle ? 'bg-white text-green-900 border-b-4 border-green-800' : 'bg-green-600 text-white'">
                          <p class="uppercase font-bold lg:text-sm text-xs pr-5"> Alien status information </p>
                          <span>
                        ...
                        <div class="border-b-4">
                          <div class="lg:flex cursor-pointer lg:px-5 px-2 pt-3 pb-3 border-b">
                            <div class="lg:flex items-center">
                              <label class="text-sm font-bold pr-5">Are you a returning student?</label>
                              <div class="flex">
                          ...
                          <div class="lg:text-sm text-xs py-3 text-black lg:px-5 px-2"> 
                            Returnee refers to an undergraduate student of LSU whose studies was discontinued for at least one (1) semester and is seeking re-admission to the University. </div>
                          <div class="lg:px-5 px-2 border-t" v-if="newStudent.returnee_student.is_student_returnee === 'yes'">
                            <div class="lg:flex gap-3 lg:mt-8 mt-5 mb-5">
                              <div class="lg:flex w-full gap-3">
                                <div class="lg:w-fit lg:mb-0 mb-5">
                                ...
                                <div class="lg:w-fit lg:mb-0 mb-5">
                                  <label class="font-bold lg:text-sm text-xs text-black w-fit whitespace-nowrap pr-10 pb-1 block"> Last Academic Year Enrolled </label>
                                ...
                                <div class="w-full lg:mb-0 mb-5">
                                  <div class="block">
                                    <p class=" font-bold lg:text-sm text-xs text-black w-fit lg:whitespace-nowrap pr-10 pb-1">
                            ...
                            <div class="w-full lg:mb-8 mb-5">
                              <p class="font-bold lg:text-sm text-xs text-black w-fit lg:whitespace-nowrap pr-5 pb-1"> 
                          ...
                          <div class="lg:flex items-center gap-3 w-full">
                            <div class="cursor-pointer w-full flex items-center">
                              <div class="lg:flex flex-wrap items-center gap-3">
                                <label class="text-sm lg:flex leading-tight lg:pr-1">
                                  <span class="font-bold lg:pr-1 lg:text-sm text-xs"> Do you intent to apply for a change of degree program? </span class="lg:text-sm text-xs"> (applicable to shiftees) </label>
                                <div class="flex lg:mt-0 mt-3">
                                  <div class="flex items-center mr-5">
                                    <input type="radio" value="yes" v-model="newStudent.shiftee_student.is_student_shiftee" class="mr-1" />
                                    <label class="text-sm"> Yes </label>
                                  </div>
                                  <div class="flex items-center">
                                    <input type="radio" value="no" v-model="newStudent.shiftee_student.is_student_shiftee" class="mr-1" />
                                    <label class="text-sm"> No </label>
                                  </div>
                                </div>
                              </div>
                            </div>
                            <div v-if="newStudent.shiftee_student.is_student_shiftee === 'yes'" class="w-full lg:mt-0 mt-3 pt-1.5 pb-2.5">
                              <div class="">
                                <label class="text-[13.5px] mb-1 text-green-800 block"> Please enter below the degree program you are applying, if your answer is <span class="font-bold">YES.</span>
                                </label>
                                <select v-model="courseSelectionShiftee" class="w-full px-3 border-b-2 border-t-0 border-x-0 border-green-700 
                      ...
                      <div class="py-5">
                        <div class="w-fit mr-0 ml-auto flex">
                          <div class="cursor-pointer py-1 uppercase px-4 shadow bg-green-800 text-white hover:bg-white hover:text-green-800 rounded-lg mx-2" @click="toggleInfo(false, true, false, false, false, false)"> Next <i class="fa fa-angle-double-right pl-2"></i>
                          </div>
                        </div>
                      </div>
                    </div>
