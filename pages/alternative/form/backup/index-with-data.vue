...
onMounted(() => {
    addPreliminaries()
    preliminariesTabCategory()
    addSibling()
})

let limitCounterSibling = ref(1);
...
const newStudent = ref({
    ...
    data_privacy_notice_consent: {
        text: [
            ...
            'Should you wish to withdraw your consent, please get in touch with us through our website www.lsu.edu.ph or email us at admissions@lsu.edu.ph.'
        ],
    ...
    student_contact_info: {
        ...
        contact: {
            ...
            personal_email_address: "juvaneeluna@gmail.com",
    ...
    hereby_certification: {
        text: [
            ...
            '(1) certify that I am 18 years old; (2) certify that I have read and fully understood all the instructions regarding my application for admission to La Salle University, and the information provided in this application and the documentation supporting it are correct and complete. I understand that incomplete or inaccurate information could be prejudicial to my admission and retention; (3) agree to the collection, use, storage, processing of my personal information; (4) warrant that my information was provided voluntarily by me to La Salle University; (4) acknowledge and agree that it may be processed and made accessible to the authorized La Salle University personnel,; and (5) agree to hold the University free and harmless from any and all losses, liabilities and/or claims of any nature, which it may suffer or incur from or in connection with its reliance on this consent.',
            'I have read the above statements and agree to all its terms and conditions. I understand that checking of the box shall be interpreted as constituting a signature of certification of the above-mentioned.'
        ],
        answer: true
    },
    statuses: [
...
const preliminariesTabCategory = (category) => {
    ...
    newStudent.value.preliminaries = [
        {
            ...
            list: {
                ...
                answers_one: '',
                follow_up_questions_two: 'Last Enrolled in LSU Basic Education:',
            }
        },
        {
            category: 'TRANSFEREE',
            list: {
                ...
                answers_one: '',
                follow_up_questions_two: 'Last Enrolled in LSU:',
            }
        },
        {
            category: 'CONTINUING',
...
<div class="bg-gray-50">
    ...
    <div class="">
        ...
        <div>
            <div class="w-11/12 mx-auto shadow px-8 py-7 mt-10 ,b-3">
                <h1 class="font-bold text-base text-green-800 text-center">
                    APPLICATION FOR ADMISSION TO LA SALLE UNIVERSITY FOR UNDERGRADUATE STUDENTS
                </h1>
            </div>

            <div class="w-11/12 mx-auto shadow px-8 py-7 my-10" v-if="lasallianGreetingsOfPeaceTab">
                <div class="">
                    <p class="text-xs mb-4 text-green-900 font-bold">
                    ...
                    <p class="text-green-900 mb-1 text-xs">
                        The documentary requirements you need to submit in original copies are detailed in the
                        Enrollment Procedures and Tracking Form for Undergraduate Students. </p>
                </div>
            </div>
            <div class="mb-10 w-fit mx-auto" v-if="lasallianGreetingsOfPeaceTab">
                <div class="cursor-pointer py-1 uppercase pr-5 pl-8 shadow bg-green-800 text-white hover:bg-white hover:text-green-800 rounded-lg mx-5 border-2 border-green-800"
                    @click="startFilling()">Start <i class="fa fa-angle-double-right ml-5"></i>
                </div>
            </div>
            <div class="" v-if="stepsTab">
                <div class="w-11/12 mx-auto items-center flex pt-5 pb-10 justify-center">
                        ...
                        <div class="">
                            <ul class="flex justify-between">
                                <li @click="toggleInfo(
                                    ...
                                    <p class="text-left text-xs mt-5  text-green-800 whitespace-nowrap">
                                        Preliminaries
                                    </p>
                                </li>
                                <li @click="toggleInfo(
                                    ...
                                    <span
                                        class=" text-white  bg-green-900 rounded-lg px-2.5 py-2 h-10 w-10 text-center">
                                ...
                                <li @click="toggleInfo(
                                    ...
                                    <span class="bg-green-900 h-0.5 w-full block -mt-2.5"></span>
                                    <p class="text-left text-xs mt-5  text-green-800 whitespace-nowrap">Survey
                                    </p>
                                </li>
                                <li @click="toggleInfo(
                                    ...
                                    <span class="bg-green-900 h-0.5 w-full block -mt-2.5"></span>
                                    <p class="text-left text-xs mt-5  text-green-800 whitespace-nowrap">Certification
                                    </p>
                                </li>
                                <li class="">
                                    <span
                                    ...
                                    <p class="text-left text-xs -ml-24  mt-3  text-green-800 whitespace-nowrap">
                        ...
                        <div>
                            <form v-on:submit.prevent="submitForm">
                                <div class="border-t-2 border-green-700 mt-5 shadow-lg rounded-lg"
                                    ...
                                    <div class="px-5 py-7">
                                        <div class="">
                                            <h2 class="font-bold text-green-900 text-sm mb-3">
                                        ...
                                        <div>
                                            <div class="flex items-center my-2">
                                                <input type="checkbox"
                                                    ...
                                                    class="mr-2" />
                                                <label class="text-xs">I have read the above statements and agree to all
                                                    its terms and conditions</label>
                                            </div>
                                            <div class="flex items-center">
                                                <input type="checkbox"
                                                    v-model="newStudent.data_privacy_notice_consent.is_eighteen_years_old_or_above"
                                                    class="mr-2" />
                                                <label class="text-xs">I am 18 years old or above</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex">
                                        <div class="w-5/12 mx-auto shadow px-8 py-7">
                                            <h2 class="font-bold uppercase text-sm text-center mt-10">
                                                Preliminaries
                                            </h2>
                                            <div class="grid grid-cols-2">
                                                <div class="rounded-lg border-2  hover:bg-white hover:text-green-700 mb-2 w-11/12 text-center mx-auto mt-3"
                                                    @click="displayPreliminaries(p)"
                                                    v-for="(p, i) in newStudent.student_classification_status" :key="i"
                                                    :class="p === preliminariesTab ? 'bg-green-950 border-green-950 text-xs font-bold px-2 py-1 text-white' : 'bg-green-700 border-green-700 text-white px-5 py-1 tracking-tighter text-xs'">
                                                    <span>
                                                        {{ p }}
                                                    </span>
                                                </div>
                                            </div>
                                            <div class="w-full px-3 text-center mt-10">
                                                <div v-for="(p, i) in newStudent.preliminaries" :key="i">
                                                ...
                                                <div class="text-center h-fit justify-center pb-4"
                                                    v-if="preliminariesTab === 'CONTINUING (change program)' || preliminariesTab === 'RETURNEE (change program)'">
                                                    <div class="flex items-center mt-6 mb-5 mx-auto w-11/12">
                                                        <label
                                                            class="text-green-900 text-xs w-5/12 text-right pr-3">Term</label>
                                                        <select
                                                            v-model="newStudent.admissions_list_filter.last_term_enrolled"
                                                            class="px-3 text-xs text-green-900 py-1 w-5/12">
                                                            <option class="text-xs text-green-900 py-2" value=""
                                                                disabled selected>Please Select
                                                                Term</option>
                                                            <option class="text-xs text-green-900 py-2" value="">1st
                                                                Semester</option>
                                                            <option class="text-xs text-green-900 py-2" value="">2nd
                                                                Semester</option>
                                                    ...
                                                    <div class="flex items-center mx-auto w-11/12">
                                                        <label
                                                            class="text-green-900 text-xs whitespace-nowrap w-5/12 text-right pr-3">Academic
                                                            Year</label>
                                                        <select
                                        ...
                                        <div class="w-7/12 shadow px-8 py-3">
                                            <div>
                                                <ul class="flex mb-5 border-b py-3 mx-auto">
                                                    <li class="w-4/12 pr-5 text-right">
                                                        <span class="text-xs whitespace-nowrap">
                                                            Full Name
                                                        </span>
                                                    </li>
                                                    <li class="items-center mb-3 w-7/12 pr-5">
                                                        <div class="w-full">
                                                ...
                                                <ul class="mb-5 border-b py-3">
                                                    <li class="flex items-center mb-3">
                                                        <span class="w-4/12 text-right pr-5 text-xs">Birth Sex</span>
                                                        <span class="w-7/12">
                                                            <input v-model="newStudent.student_personal_info.birth_sex"
                                                                class="w-full text-xs px-3 py-1 capitalize border-b-2 border-t-0 border-x-0 
                                                                border-green-700 shadow-lg rounded-sm"
                                                    ...
                                                    <li class="flex items-center mb-3">
                                                        <span class="w-4/12 text-right pr-5 text-xs">
                                                ...
                                                <ul class="">
                                                    <li class="flex items-center mb-3" 
                                                        ...
                                                        <span class="w-4/12 text-right pr-5 text-xs capitalize">
                                                    ...
                                                    <li class="flex items-center mb-3">
                                                        ...
                                                        <span class="w-7/12">
                                                            <input v-model="newStudent.admissions_list_filter.college"
                                                                class="w-full text-xs px-3 py-1 capitalize border-b-2 border-t-0 border-x-0 
                                                                border-green-700 shadow-lg rounded-sm"
                                                                placeholder="college" />
                                                        </span>
                                                    ...
                                                    <li class="flex items-center mb-3">
                                                        ...
                                                        <span class="w-7/12">
                                                            <input v-model="newStudent.admissions_list_filter.new_term"
                                                                class="w-full text-xs px-3 py-1 capitalize border-b-2 border-t-0 border-x-0 
                                                                border-green-700 shadow-lg rounded-sm"
                                                    ...
                                                    <!-- <li class="flex items-center mb-3"
                                                        v-if="preliminariesTab === 'CONTINUING (change program)' ||    
                                                            preliminariesTab === 'RETURNEE (change program)'
                                                        ">
                                                        <span class="w-4/12 text-right pr-5 text-xs capitalize">
                                                            last academic year enrolled
                                                        </span>
                                                        <span class="w-7/12">
                                                            <input
                                                                v-model="newStudent.admissions_list_filter.last_academic_year_enrolled"
                                                                class="w-full text-xs px-3 py-1 capitalize border-b-2 border-t-0 border-x-0 
                                                                border-green-700 shadow-lg rounded-sm"
                                                                placeholder="last academic year enrolled" />
                                                        </span>
                                                    </li> -->
                                                    <!-- <li class="flex items-center mb-3"
                                                        v-if="preliminariesTab === 'CONTINUING (change program)' ||    
                                                        ...
                                                        <span class="w-7/12">
                                                            <input
                                                                ...
                                                                class="w-full text-xs px-3 py-1 capitalize border-b-2 border-t-0 border-x-0 
                                                                border-green-700 shadow-lg rounded-sm"
                                                                placeholder="last term enrolled" />
                                                        </span>
                                                    </li> -->
                                                    <li class="flex items-center mb-3"
                                                        v-if="preliminariesTab === 'NEW FRESHMAN' || 
                                                    ...
                                                    <li class="flex items-center mb-3" 
                                                        v-if="preliminariesTab === 'CONTINUING' || 
                                                        ...
                                                        <span class="w-7/12">
                                                            <input v-model="newStudent.admissions_list_filter.program"
                                                                class="w-full text-xs px-3 py-1 capitalize border-b-2 border-t-0 border-x-0 
                                                                border-green-700 shadow-lg rounded-sm"
                                                                placeholder="program" />
                                                        </span>
                                    ...
                                    <div>
                                            ...
                                            <div class="">
                                                <div>
                                                    <div class="flex gap-3">
                                                        <div class="">
                                                            ...
                                                            <div>
                                                                <input type="text" class="w-20 capitalize border-b-2 border-t-0 border-x-0 border-green-700 
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="flex">
                                                                <input type="text" class="w-20 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg 
                                                ...
                                                <div class="flex gap-3">
                                                    <div>
                                                        ...
                                                        <div class="flex">
                                                            ...
                                                            <select class="w-fit px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700
                                                                 shadow-lg rounded-sm h-9 text-xs"
                                                                v-model="newStudent.student_personal_info.birth_sex">
                                                                <option value="" disabled selected hidden>Birth Sex
                                                                </option>
                                                    ...
                                                    <div>
                                                        <label class="text-[10px] text-gray-300 lg:block hidden">Birth
                                                            Date</label>
                                                        <div>
                                                            <input type="date" class="w-44 px-3 border-b-2 border-t-0 border-x-0 
                                                    ...
                                                    <div>
                                                        ...
                                                        <div>
                                                            <select class="w-24 px-3 capitalize border-b-2 border-t-0 border-x-0
                                                                 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                    ...
                                                    <div>
                                                        ...
                                                        <div>
                                                            <select
                                                                class="w-fit px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                ...
                                                <div class="flex gap-3">
                                                    <div>
                                                        ...
                                                        <div>
                                                            <select
                                                                class="w-44 px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                v-model="newStudent.student_personal_info.civil_status">
                                                                <option value="" disabled selected hidden>Civil Status
                                                                </option>
                                                    ...
                                                    <div class="flex items-center w-full pt-3">
                                                        <p class="text-xs mr-5 text-green-900">Do you belong to a
                                        ...
                                        <div class="border-b-4 px-10 py-5">
                                            ...
                                            <div class="">
                                                ...
                                                <div class="mb-3 flex items-center pt-3">
                                                    <p class="text-xs text-green-900 mr-3 pt-1">
                                        ...
                                        <div class="border-b-4 px-10 py-5">
                                            <p class="text-green-800 uppercase font-bold mb-1">ALIEN STATUS INFORMATION
                                            </p>
                                ...
                                <div class="mx-auto border-t-2 border-green-700 mt-5 shadow-lg rounded-lg"
                                    ...
                                    <div>
                                        <div class="parents flex">
                                            <div class="border-b-4 px-7 py-5">
                                                <div>
                                                    <div>
                                                        <p class="text-green-800 uppercase font-bold mb-3">
                                                            Father Information
                                        ...
                                        <div class="border-b-4 px-10 py-5">
                                            ...
                                            <div>
                                                <div class="lg:flex lg:shadow rounded-xl lg:p-5 mt-2 mb-3 relative"
                                                    ...
                                                    <div class="w-full">
                                                        <div class="flex personal-details">
                                                        ...
                                                        <div class="flex educational-details">
                                                            <div class="w-full lg:mb-0 mb-2">
                                                                <label
                                                                    class="text-[10px] text-gray-300 lg:block hidden">
                                                                    Grade or Year Level
                                ...
                                <div class="mx-auto border-t-2 border-green-700 mt-5 shadow-lg rounded-lg pt-5"
                                    ...
                                    <div>
                                        <div class="border-b-4 px-5 pb-3 mb-5">
                                            <p class="text-green-800 uppercase font-bold mb-3">EDUCATIONAL INFORMATION
                                            </p>
                                            <p class="text-xs text-gray-500 mb-3">
                                                Please add all your previous educational detail information and double
                                            ...
                                            <div>
                                                <div class="mb-3 flex w-full">
                                                    <div class="flex items-center w-full cursor-pointer"
                                                        ...
                                                        <span
                                                            class="justify-center flex w-full items-center px-3 py-0.5 h-fit whitespace-nowrap hover:bg-green-700 hover:text-white"
                                                            :class="b === currentEducationalTab ? 'bg-green-900 text-white' : 'bg-white border border-green-900 text-green-900'">
                                                            {{ b }}
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="" v-for="(b, i) in educationalActiveTabFilter" :key="i">
                                                    <div class="lg:flex items-end rounded-xl gap-2 mb-3 relative">
                                                        <div class="w-[800px] lg:mb-0 mb-2">
                                                            <label
                                                                class="text-[10px] text-gray-300 lg:block hidden lg:whitespace-nowrap">
                                                                Education Level
                                                            </label>
                                                            <input
                                ...
                                <div class="mx-auto border-t-2 border-green-700 mt-5 shadow-lg rounded-lg pt-5"
                                    ...
                                    <div class="border-b-4 px-10 pb-5 flex items-center">
                                        <p class="text-green-800 font-semibold mb-1 w-[150px] pt-2 text-sm mr-5">
                                            What are your Top 3 programs of choice?
                                        </p>
                                        <div class="w-full">
                                            <div class="flex gap-3">
                                                <div class="w-full">
                                                    <label class="text-xs text-gray-700">1st
                                                ...
                                                <div class="w-full">
                                                    <label class="text-xs text-gray-700">2nd
                                                        <!-- <span class="text-red-500">*</span> -->
                                                    </label>
                                                    <select required
                                                ...
                                                <div class="w-full">
                                                    <label class="text-xs text-gray-700">3rd
                                                        <!-- <span class="text-red-500">*</span> -->
                                                    </label>
                                                    <select required
                                ...
                                <div class="mx-auto border-t-2 border-green-700 mt-5 shadow-lg rounded-lg"
                                    ...
                                    <div class="shadow px-8 py-7">
                                        ...
                                        <div class="flex items-center">
                                            <input type="radio" class="mr-1.5"
                                                v-model="newStudent.has_health_condition.answer" value="false" />
                                            <label class="text-xs">
                                                No
                                            </label>
                                        </div>
                                    ...
                                    <div class="border-b-4 border-green-800 px-5 flex">
                                        ...
                                        <div class="mt-6 text-center">
                                            <p class="text-green-800 text-center">
                                                Please check all your information before submitting ...</p>
                                        </div>
                                    </div>
                                    <div class="">
