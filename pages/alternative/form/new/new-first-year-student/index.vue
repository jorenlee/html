<script setup>
  ...
  const staticNewStudentTexts = ref({
    has_health_condition: {
      text: ['Support for Students with Health Conditions:', 
  ...
  const newStudent = ref({
    tracking_id: "TIDNFY" + moment().valueOf(),
    ...
    new_student_placement: {
      details: 'Placement (New First Year Student and Transferee)',
...
const submitToAPI = async () => {
    await $fetch(endpoint.value + "/api/admissions-first-sem/new-student/create/", {
      method: "POST",
      headers: {
  ...
  const submitFunc = async () => {
    ...
    if(newStudent.value.student_lsu_id_number === '' || newStudent.value.student_lsu_id_number === 'no') {
...
<template>
  <div class="bg-gray-50">
    ...
    <div class="">
      ...
      <div>
        <div class="w-11/12 mx-auto shadow lg:px-8 px-3 lg:py-7 py-3 lg:mt-10 mt-3 lg:mb-3">
          <h1 class="font-bold lg:text-2xl text-xs text-green-800 text-center"> 
            APPLICATION FOR UNDERGRADUATE STUDENTS : New First Year Status 
          </h1>
              ...
              <div class="">
                <ul class="flex justify-between">
                  <li class="w-full ">
                    ...
                    <p class="hidden text-left lg:text-xs text-[10px]  mt-5  text-green-800 lg:flex "> Student Information </p>
                  </li>
                  <li class="w-full ">
                    ...
                    <span class="bg-green-900 h-0.5 w-full block -mt-2.5"></span>
                    <p class="hidden text-left lg:text-xs text-red-800 text-[10px]  mt-5   lg:flex "> Detailed Student Profile </p>
                  </li>
                  <li class="w-full">
                    ...
                    <span class="bg-green-900 h-0.5 w-full block -mt-2.5"></span>
                    <p class="hidden text-left lg:text-xs text-[10px] mt-5  text-green-800 lg:flex "> Media Release Consent </p>
                  </li>
                  <li class="w-full">
                    <span class=" text-white  bg-green-900 rounded-lg lg:px-3 px-2 lg:py-2 pt-0 pb-1 h-10 w-10 text-center">
                    ...
                    <span class="bg-green-900 h-0.5 w-full block -mt-2.5"></span>
                    <p class="hidden text-left lg:text-xs text-[10px] mt-5  text-green-800  lg:flex "> Health Information </p>
                  </li>
                  <li class="">
                    <span class=" text-white  bg-green-900 rounded-lg lg:px-3 px-1.5 lg:py-2 pt-0 pb-1 h-10 w-10 text-center">
                      <i class="lg:text-sm text-xs fa fa-paper-plane" aria-hidden="true"></i>
                    </span>
                    <p class="hidden text-left lg:text-xs text-[10px] -ml-24  mt-3  text-green-800 lg:flex "> Submit and Check Email </p>
                  </li>
                </ul>
              </div>
              <div>
                    ...
                    <div>
                            ...
                            <div class="flex gap-3">
                              <div class="mb-3 w-full">
                                <div class="lg:flex w-full gap-3">
                                  <div class="lg:flex gap-3 w-full lg:mb-0 mb-2">
                                    <div class="w-full">
                      ...
                      <div class="border-b-4">
                        ...
                        <div class="mt-3 lg:pb-5 pb-3 lg:px-5 px-2">
                          ...
                          <div class="lg:flex gap-3 mt-5 border-t-4 lg:pb-3 border-gray lg:pt-6 pt-2">
                      ...
                      <div class="lg:px-5 px-2 lg:flex border-b-4 lg:pt-6 pt-3 pb-3 gap-3">
                        <div class="lg:flex gap-3 mb-5 w-full">
                          <div class="w-full lg:mb-0 mb-5">
                            <label class="font-bold lg:text-sm text-xs text-black w-fit whitespace-nowrap pr-10 pb-1 block"> Senior Highschool Track </label>
                            <input type="text" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" 
                            v-model="newStudent.senior_highschool_track"
                            placeholder="Senior Highschool Track" />
                          </div>
                          <div class=" w-full lg:mb-0 mb-5">
                            <label class="font-bold lg:text-sm text-xs text-black w-fit whitespace-nowrap pr-10 pb-1 block"> Senior Highschool Strand </label>
                            <input type="text" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" placeholder=" Senior Highschool Strand" 
                            v-model="newStudent.senior_highschool_strand"
                            />
                          </div>
                        </div>
                        <div class="lg:flex gap-3 w-full">
                          <div class=" w-full lg:mb-0 mb-5">
                            ...
                            <input type="text" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" placeholder="Last School Attended" 
                            v-model="newStudent.last_school_attended"
                            
                            />
                          </div>
                          <div class="lg:w-4/12 w-full lg:mb-0 mb-2">
                            <label class="font-bold lg:text-sm text-xs text-black w-fit whitespace-nowrap pr-10 pb-1 block"> SHS Year Graduated </label>
                            <input type="text" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                             placeholder="SHS Year Graduated" 
                            v-model="newStudent.shs_year_graduated"
                            />
                          </div>
                        </div>
                      </div>
                      <div class="" v-if="newStudent.citizenship === 'non-filipino'">
                        ...
                        <div class="mt-3 pb-5 px-10 border-b-4" v-if="studentAlienStatusInformationToggle">
                      ...
                      <div class="py-5 px-10" v-if="requiredDegreeProgram">
                        <div class="w-full py-1 bg-red-900 text-white text-center">
                          Please Select Degree Program | All Fields are required
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="border-t-2 border-green-700 my-5 shadow-lg" v-show="toggle.two">
                    <div>
                      ...
                      <div class="pb-5">
                        ...
                        <div class="lg:flex gap-3 mt-5 border-t-4 pb-3 border-gray lg:pt-6 pt-3 lg:px-5 px-2">
                            <div class="lg:w-3/12 lg:mb-0 mb-3">
                              <label class="text-sm mb-1 text-black lg:block  font-bold"> 
                                Academic Year </label>
                              <div>
