<script setup>
  ...
  const newStudent = ref({
    tracking_id: "TIDT" + moment().valueOf(),
    ...
    enrollment_tracking_status: [{
      ...
      label: 'CITS or NPCC',
      details: 'Student Portal Accounts, LSU Email and Verifications',
      date_checked: '-',
      check_by: '-',
      status: '',
      remarks: ''
    ...
    transferee_student_placement: {
      details: 'Placement and Course Crediting (Transferee)',
      department: 'Career & Counseling Center',
      test_administration_status: "",
      counselor_student_encounter_status: "",
      accepting_college: "",
      approval_status: ""
    },
    credentials: {
      ...
      student_lsu_email_username: "",
      student_lsu_email_password: "",
      student_canvas_username: "",
      student_canvas_password: "" 
    }
  })
  ...
  const submitNewStudentToGmail = async () => {
    await $fetch(endpoint.value + "/api/admissions-first-sem/new-tracking-id/", {
      method: "POST",
      headers: {
  ...
  const vitalLifeStatusSelection = () => {
    if (newStudentFull.value.father_personal_info.vital_life_status === 'living') {
        fatherInfo.value = true;
    }
    if (newStudentFull.value.father_personal_info.vital_life_status === 'deceased') {
        fatherInfo.value = false;
    }
    if (newStudentFull.value.mother_personal_info.vital_life_status === 'living') {
        motherInfo.value = true;
    }
    if (newStudentFull.value.mother_personal_info.vital_life_status === 'deceased') {
...
let requiredDegreeProgram = ref(false);
const firstNext = () => {
  assignCollege()
  if(newStudent.value.program === null) {
    requiredDegreeProgram.value = true;
    setTimeout(() => {
      requiredDegreeProgram.value = false;
    }, 3000)
  } else {
...
const submitToAPI = async () => {
    await $fetch(endpoint.value + "/api/admissions-first-sem/transferee/create/", {
      method: "POST",
      headers: {
        "Content-Type": "application/json"
      },
...
const theSameAddressBtn = (choice) => {
    if (choice === 'yesStudentContactInfo') {
        newStudentFull.value.student_contact_info.the_same_address.answer = 'yes'
        newStudentFull.value.student_contact_info.current_or_present_living_home_address_category = newStudentFull.value.student_contact_info.permanent_living_home_address_category
        // console.log(newStudentFull.value)
    }
    if (choice === 'noStudentContactInfo') {
        newStudentFull.value.student_contact_info.the_same_address.answer = 'no'
        newStudentFull.value.student_contact_info.current_or_present_living_home_address_category = {}
    }
    if (choice === 'yesFatherContactInfo') {
        newStudentFull.value.father_contact_info.the_same_address.answer = 'yes'
        newStudentFull.value.father_contact_info.current_or_present_living_home_address_category = newStudentFull.value.father_contact_info.permanent_living_home_address_category
        // console.log(newStudentFull.value)
    }
    if (choice === 'noFatherContactInfo') {
        newStudentFull.value.father_contact_info.the_same_address.answer = 'no'
        newStudentFull.value.father_contact_info.current_or_present_living_home_address_category = {}
    }
    if (choice === 'yesMotherContactInfo') {
        newStudentFull.value.mother_contact_info.the_same_address.answer = 'yes'
        newStudentFull.value.mother_contact_info.current_or_present_living_home_address_category = newStudentFull.value.mother_contact_info.permanent_living_home_address_category
        // console.log(newStudentFull.value)
    }
    if (choice === 'noMotherContactInfo') {
        newStudentFull.value.mother_contact_info.the_same_address.answer = 'no'
        newStudentFull.value.mother_contact_info.current_or_present_living_home_address_category = {}
    }
    if (choice === 'yesGuardianContactInfo') {
        newStudentFull.value.legal_guardian_contact_info.the_same_address.answer = 'yes'
        newStudentFull.value.legal_guardian_contact_info.current_or_present_living_home_address_category = newStudentFull.value.legal_guardian_contact_info.permanent_living_home_address_category
        // console.log(newStudentFull.value)
    }
    if (choice === 'noGuardianContactInfo') {
        newStudentFull.value.legal_guardian_contact_info.the_same_address.answer = 'no'
        newStudentFull.value.legal_guardian_contact_info.current_or_present_living_home_address_category = {}
    }
}

  const submitToStudentProfile = async () => {
    await $fetch(endpoint.value + "/api/admissions-first-sem/student-profile/create/", {
      method: "POST",
      headers: {
        "Content-Type": "application/json"
      },
  ...
  const assignCollegeTransferee = () => {
    newStudent.value.transferee_student.college = courseSelectionTransferee.value.college
    newStudent.value.transferee_student.program = courseSelectionTransferee.value.program
  }
  const assignCollege = () => {
  ...
  let primaryInfo = () => {
    newStudentFull.value.primary_info.tracking_id = newStudent.value.tracking_id 
    newStudentFull.value.primary_info.student_lsu_id_number = newStudent.value.student_lsu_id_number 
    newStudentFull.value.primary_info.lastname = newStudent.value.lastname 
    newStudentFull.value.primary_info.firstname = newStudent.value.firstname 
    newStudentFull.value.primary_info.middlename = newStudent.value.middlename 
    newStudentFull.value.primary_info.extension_or_suffix_name = newStudent.value.extension_or_suffix_name 
    newStudentFull.value.primary_info.birth_sex = newStudent.value.birth_sex 
    newStudentFull.value.primary_info.birth_date = newStudent.value.birth_date 
    newStudentFull.value.primary_info.citizenship = newStudent.value.citizenship 
    newStudentFull.value.primary_info.college = newStudent.value.college 
    newStudentFull.value.primary_info.program = newStudent.value.program 
    newStudentFull.value.primary_info.contact_primary_number = newStudent.value.contact_primary_number 
    newStudentFull.value.primary_info.contact_alternate_number = newStudent.value.contact_alternate_number 
    newStudentFull.value.primary_info.contact_personal_email_address = newStudent.value.contact_personal_email_address 
    newStudentFull.value.primary_info.contact_lsu_email_address = newStudent.value.contact_lsu_email_address 
  }
  ...
  const submitFunc = async () => {
    ...
    if(newStudent.value.student_lsu_id_number === '') {
      newStudent.value.student_lsu_id_number = 'N/A'
    }
    if(newStudent.value.contact_lsu_email_address === '') {
      newStudent.value.contact_lsu_email_address = 'dev@lsu.edu.ph'
    }
    submitToAPI();
  }
...
<template>
  <div class="bg-gray-50">
    ...
    <div class="">
      ...
      <div>
        <div class="w-11/12 mx-auto shadow lg:px-8 px-3 lg:py-7 py-2 lg:mt-10 mt-3 lg:mb-3">
          <h1 class="font-bold lg:text-2xl text-xs text-green-800 text-center"> APPLICATION FOR UNDERGRADUATE STUDENTS : Transferee Status </h1>
          <p class=" text-center cursor-default lg:text-sm text-xs"> An undergraduate student known to have attended a different college/university prior to seeking admission to the University. </p>
        </div>
        <div v-if="stepsTab">
            ...
            <div class="mt-3 w-full">
              <div class="">
                <ul class="flex justify-between">
                  <li class="w-full ">
                    ...
                    <p class="text-left lg:text-xs text-[10px]  mt-5  text-green-800 lg:whitespace-nowrap lg:flex hidden"> 
              ...
              <div>
                <form v-on:submit.prevent="submitForm">
                  <div class="border-t-2 border-green-700 mt-5 shadow-lg" v-show="toggle.one">
                    <div>
                                ...
                                <div class="lg:flex w-full gap-3">
                                  <div class="lg:flex gap-3 w-full lg:mb-0 mb-3">
                                    <div class="w-full">
                                      <label class="text-[10px] text-gray-900 lg:block  pb-1">
                                        Last Name</label>
                                      <input type="text" 
                                        class="w-full capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" 
                                        placeholder="Last Name" 
                                        v-model="newStudent.lastname" />
                                    </div>
                                    <div class="w-full">
                                      <label class="text-[10px] text-gray-900 lg:block pb-1">First Name</label>
                                      <input type="text" class="w-full capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" 
                                  ...
                                  <div class="lg:flex gap-3">
                                    <div>
                                      ...
                                      <div class="flex">
                                        <input type="text" 
                                        class="lg:w-20 w-full capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" 
                                    ...
                                    <div>
                                      ...
                                      <div>
                                        <input type="date" 
                                          class="lg:w-44 w-full border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" 
                                          placeholder="Date of Birth" 
                                          v-model="newStudent.birth_date" />
                                      </div>
                                    </div>
                                    <div class="lg:flex gap-3 grid lg:grid-cols-2">
                                      <div>
                      ...
                      <div class="border-b-4">
                        ...
                        <div class="mt-3 lg:pb-5 pb-3 lg:px-5 px-2">
                          <div class="lg:flex gap-3">
                            <div class="lg:flex w-full gap-3">
                              <div class="w-full lg:mb-0 mb-3">
                                ...
                                <div>
                                  <input type="text" class="w-full text-xs px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9" 
                            ...
                            <div class="w-full lg:mb-0 mb-3"
                                v-if="newStudent.former_lsu_student === 'yes'">
                            ...
                            <div class="lg:mb-0 mb-3">
                              <label class="text-[10px] text-gray-900 lg:block  pb-1 whitespace-nowrap"> 
                                Are you a former student of LSU-Ozamiz? 
                                <span class="text-red-600">*</span>
                              </label>
                              <div class="flex justify-center lg:w-auto lg:gap-5 pt-2.5 pb-2 lg:pl-4 pr-1 pl-3 shadow bg-green-100 border-b-2 border-green-700 w-fit">
                                <div class="flex mr-3">
                                  <input type="radio"
                                     value="yes" 
                                     v-model="newStudent.former_lsu_student" 
                                     class="lg:mr-2 mr-1" />
                            ...
                            <div class="lg:mb-0 mb-3" 
                              ...
                              <div class="flex">
                                ...
                                <span @click="infoText = !infoText" 
                                  class="text-center cursor-pointer bg-green-800 font-bold 
                                    border border-green-900 text-white rounded-full px-1.5 h-5 w-5 ml-3 mt-2">
                                  <i class="fa fa-question mt-0.5 -ml-[1px] flex"></i>
                                </span>
                              </div>
                              <div v-if="infoText" 
                                  class="text-green-900 text-xs mt-3 leading-tight min-w-[250px]"> 
                                  Enter your ID number as registered on your account or as shown on your Student ID Card </div>
                              </div>
                              <div class="lg:mb-0 mb-3" 
                              v-if="newStudent.former_lsu_student === 'no'">
                              <div class="flex items-center">
                          ...
                          <div class="lg:flex gap-3 mt-5 border-t-4 pb-3 border-gray lg:pt-6 pt-3">
                            ...
                            <div class="w-full mx-auto lg:mb-0 mb-3">
                            ...
                            <div class="w-full mx-auto lg:mb-0">
                              <label class="text-sm mb-1 text-black lg:block font-bold"> Previous Degree Program </label>
                              <select v-model="courseSelectionTransferee" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm text-black h-9 text-xs">
                                <option value="Select Course Program" selected disabled>Select Course Program</option>
                                <option :value="cp" v-for="(cp, i) in courseOrProgramData" :key="i">
                                  {{ cp.college }} | {{ cp.program }}
                                </option>
                      ...
                      <div class="border-b-4 py-2">
                        <div class="lg:px-5 px-2 mb-5">
                          <div class="lg:flex pt-3 gap-3">
                            <div class="lg:w-3/12 lg:mb-0 mb-3">
                              <label class="font-bold lg:text-sm text-xs text-black w-fit whitespace-nowrap pr-10 pb-1 block"> Last Term Enrolled </label>
                              <select v-model="newStudent.last_term_enrolled" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs">
                                <option class="text-xs text-black py-2" value="Select Term" disabled> Select Term </option>
                                <option class="text-xs text-black py-2" value="1st Semester">1st Semester</option>
                                <option class="text-xs text-black py-2" value="2nd Semester">2nd Semester</option>
                                <option class="text-xs text-black py-2" value="Summer"> Summer </option>
                              </select>
                            </div>
                            <div class="lg:w-3/12 lg:mb-0 mb-3">
                              <label class="flex font-bold lg:text-sm text-xs text-black w-fit whitespace-nowrap pr-10 pb-1">
                                <span>Last Academic Year Enrolled</span>
                              </label>
                              <select v-model="newStudent.last_academic_year_enrolled" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs">
                                <option class="text-xs text-black py-2" value="Select Academic Year" disabled>Select Academic Year </option>
                                <option class="text-xs text-black py-2" value="A.Y. 2010 - 2011"> A.Y. 2010 - 2011 </option>
                                <option class="text-xs text-black py-2" value="A.Y. 2011 - 2012"> A.Y. 2011 - 2012 </option>
                                <option class="text-xs text-black py-2" value="A.Y. 2012 - 2013"> A.Y. 2012 - 2013 </option>
                                <option class="text-xs text-black py-2" value="A.Y. 2013 - 2014"> A.Y. 2013 - 2014 </option>
                                <option class="text-xs text-black py-2" value="A.Y. 2014 - 2015"> A.Y. 2014 - 2015 </option>
                                <option class="text-xs text-black py-2" value="A.Y. 2015 - 2016"> A.Y. 2015 - 2016 </option>
                                <option class="text-xs text-black py-2" value="A.Y. 2016 - 2017"> A.Y. 2016 - 2017 </option>
                                <option class="text-xs text-black py-2" value="A.Y. 2017 - 2018"> A.Y. 2017 - 2018 </option>
                                <option class="text-xs text-black py-2" value="A.Y. 2018 - 2019"> A.Y. 2018 - 2019 </option>
                                <option class="text-xs text-black py-2" value="A.Y. 2019 - 2020"> A.Y. 2019 - 2020 </option>
                                <option class="text-xs text-black py-2" value="A.Y. 2020 - 2021"> A.Y. 2020 - 2021 </option>
                                <option class="text-xs text-black py-2" value="A.Y. 2021 - 2022"> A.Y. 2021 - 2022 </option>
                                <option class="text-xs text-black py-2" value="A.Y. 2022 - 2023"> A.Y. 2022 - 2023 </option>
                                <option class="text-xs text-black py-2" value="A.Y. 2023 - 2024"> A.Y. 2023 - 2024 </option>
                              </select>
                            </div>
                            <div class="w-full">
                              <label class="font-bold lg:text-sm text-xs text-black w-fit whitespace-nowrap pr-10 pb-1 block"> Last School Attended </label>
                              <input v-model="newStudent.last_school_attended" type="text" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" placeholder="Last School Attended" />
                            </div>
                      ...
                      <div class="border-b-4" v-if="newStudent.citizenship === 'non-filipino'">
                        <div @click="studentAlienStatusInformationToggle = !studentAlienStatusInformationToggle" class="flex justify-between px-3 items-center cursor-pointer" :class="studentAlienStatusInformationToggle ? 'bg-white text-green-900 border-b-4 border-green-800' : 'bg-green-600 text-white'">
                          <p class="uppercase font-bold lg:text-sm text-xs"> Alien status information </p>
                          <span>
                            <i class="fa text-2xl" :class="studentAlienStatusInformationToggle ? 'fa-caret-up' : 'fa-caret-down'"></i>
                          </span>
                        </div>
                        <div class="mt-3 pb-5 px-10" v-if="studentAlienStatusInformationToggle">
                          <div class="lg:flex grid grid-cols-2 gap-3 mb-2">
                            <div class="w-full">
                              <label class="text-[10px] text-gray-300"> Citizenship</label>
                              <input type="text" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" v-model="newStudent.alien_status_information.citizenship" placeholder="Citizenship" />
                            </div>
                            <div class="w-full">
                              <label class="text-[10px] text-gray-300"> Visa Status </label>
                              <input type="text" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" v-model="newStudent.alien_status_information.visa_status" placeholder="Visa Status" />
                            </div>
                            <div class="w-full">
                              <label class="text-[10px] text-gray-300"> Last Day Authorized Stay </label>
                              <input type="text" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" v-model="newStudent.alien_status_information.last_day_of_authorized_stay" placeholder="Last Day of Authorized Stay" />
                            </div>
                            <div class="w-full">
                              <label class="text-[10px] text-gray-300"> Agent Name </label>
                              <input type="text" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" v-model="newStudent.alien_status_information.agent_name" placeholder="Agent Name" />
                            </div>
                          </div>
                          <div class="lg:flex grid grid-cols-2 gap-3 mb-2">
                            <div class="w-full">
                              <label class="text-[10px] text-gray-300"> Passport Number </label>
                              <input type="text" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" v-model="newStudent.alien_status_information.passport_number" placeholder="Passport Number" />
                            </div>
                            <div class="w-full">
                              <label class="text-[10px] text-gray-300"> Passport: Place Issued </label>
                              <input type="text" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" v-model="newStudent.alien_status_information.passport_place_issued" placeholder="Passport: Place Issued" />
                            </div>
                            <div class="w-full">
                              <label class="text-[10px] text-gray-300"> Passport: Date Issued </label>
                              <input type="date" class="w-full px-3 uppercase border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" v-model="newStudent.alien_status_information.passport_date_issued" placeholder="Passport: Date Issued" />
                            </div>
                            <div class="w-full">
                              <label class="text-[10px] text-gray-300"> Passport: Date of Expiry </label>
                              <input type="date" class="w-full px-3 uppercase border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" v-model="newStudent.alien_status_information.passport_date_of_expiry" placeholder="Passport: Date of Expiry" />
                            </div>
                          </div>
                          <div class="lg:flex grid grid-cols-2 gap-2">
                            <div class="w-full">
                              <label class="text-[10px] text-gray-300"> ACR: I-CARD: Date Issued </label>
                              <input type="date" class="w-full px-3 uppercase border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" v-model="newStudent.alien_status_information.acricard_date_issued" placeholder="ACRICARD Date Issued" />
                            </div>
                            <div class="w-full">
                              <label class="text-[10px] text-gray-300"> ACR: I-CARD: Expiry Date </label>
                              <input type="date" class="w-full px-3 uppercase border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" v-model="newStudent.alien_status_information.acricard_date_of_expiry" placeholder="ACRICARD Date of Expiry" />
                            </div>
                            <div class="w-full">
                              <label class="text-[10px] text-gray-300"> CRTS: Date Issued </label>
                              <input type="date" class="w-full px-3 uppercase border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" v-model="newStudent.alien_status_information.crts_date_issued" placeholder="CRTS Date Issued" />
                            </div>
                            <div class="w-full">
                              <label class="text-[10px] text-gray-300"> CRTS: Date of Expiry </label>
                              <input type="date" class="w-full px-3 uppercase border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" v-model="newStudent.alien_status_information.crts_date_of_expiry" placeholder="CRTS Date of Expiry" />
                            </div>
                            <div class="w-full">
                              <label class="text-[10px] text-gray-300"> SSP: Date Issued </label>
                              <input type="date" class="w-full px-3 uppercase border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" v-model="newStudent.alien_status_information.ssp_date_issued" placeholder="SSP Date Issued" />
                            </div>
                            <div class="w-full">
                              <label class="text-[10px] text-gray-300"> SSP: Date of Expiry </label>
                              <input type="date" class="w-full px-3 uppercase border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" v-model="newStudent.alien_status_information.ssp_date_of_expiry" placeholder="SSP Date of Expiry" />
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="py-5">
                        <div class="w-fit mr-0 ml-auto flex">
                          <div class="cursor-pointer py-1 uppercase px-4 shadow bg-green-800 text-white 
                            hover:bg-white hover:text-green-800 rounded-lg mx-2" 
                    ...
                    <div>
                      ...
                      <div class="pb-5">
                        <div class="">
                          ...
                          <div class="mt-3 pb-5 lg:px-5">
                            <div>
                              <div class="lg:flex gap-3">
                                <div class="mb-3 w-full">
                                  <div class="lg:flex w-full gap-3 px-2">
                                    <div class="lg:flex gap-3 w-full lg:mb-0 mb-3">
                                      <div class="w-fit">
                                        <label class="text-[10px] text-gray-900 block  pb-1">Title</label>
                                        <select class="w-32 px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" v-model="newStudentFull.primary_info.title">
                                          <option value="" disabled selected hidden>  Mr. / Ms. </option>
                                      ...
                                      <div class="w-full">
                                        ...
                                        <input type="text" class="w-full capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" placeholder="Last Name" v-model="newStudent.lastname" />
                                      </div>
                                      <div class="w-full">
                                        <label class="text-[10px] text-gray-900 lg:block  pb-1">First Name</label>
                                        <input type="text" class="w-full capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" placeholder="First Name" v-model="newStudent.firstname" />
                                      </div>
                                      <div class="w-full">
                                        <label class="text-[10px] text-gray-900 lg:block  pb-1">Middle Name</label>
                                        <input type="text" class="w-full capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" placeholder="Middle Name" v-model="newStudent.middlename" />
                                      </div>
                                    </div>
                                    <div class="lg:flex gap-3">
                                      <div>
                                        <label class="text-[10px] text-gray-900 lg:block  pb-1"> Suffix Name </label>
                                        <div class="flex">
                                          <input type="text" class="lg:w-20 w-full capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" v-model="newStudent.extension_or_suffix_name" placeholder="Suffix" />
                                        </div>
                                      </div>
                                      <div class="">
                                      ...
                                      <div>
                                        ...
                                        <div>
                                          <input type="date" class="lg:w-44 w-full border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" placeholder="Date of Birth" v-model="newStudent.birth_date" />
                                        </div>
                                      </div>
                                  ...
                                  <div class="lg:flex w-full gap-3">
                                    <div class="lg:flex gap-3">
                                      <div>
                                        ...
                                        <div>
                                          <select class="lg:w-fit w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" v-model="newStudentFull.primary_info.birth_order">
                                            <option value="" disabled selected hidden>Birth Order </option>
                                      ...
                                      <div class="w-full">
                                        ...
                                        <div>
                                          <input type="text" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" v-model="newStudentFull.primary_info.birth_place" placeholder="Birth Place" />
                                        </div>
                                      </div>
                                      <div class="mb-3 w-full">
                                        <label class="text-[10px] text-gray-900 lg:block  pb-1">Religion</label>
                                        <div>
                                          <input type="text" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" v-model="newStudentFull.primary_info.religion" placeholder="Religion" />
                                        </div>
                                      </div>
                                      <div>
                                        <label class="text-[10px] text-gray-900 lg:block  pb-1"> Civil Status </label>
                                        <div>
                                          <select class="lg:w-44 w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" v-model="newStudentFull.primary_info.civil_status">
                                      ...
                                      <div>
                                        ...
                                        <div>
                                          <select class="lg:w-44 w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" v-model="newStudentFull.primary_info.nationality">
                                            <option value="" disabled selected hidden> Languages Spoken </option>
                                      ...
                                      <div>
                                        ...
                                        <div>
                                          <input type="text" class="lg:w-44 w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" v-model="newStudentFull.primary_info.ethnicity" placeholder="Ethnicity" />
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                          ...
                          <div>
                            <div class="border-y py-5 flex px-5 gap-3">
                              <div class="lg:flex items-center lg:pt-3 w-11/12">
                                <p class="text-xs lg:mb-0 mb-3 lg:mr-5 text-green-900">Do you belong to a Tribal/Indigenous Community?</p>
                                <div class="flex items-center">
                                  <span class="flex items-center">
                                    <input type="radio" value="yes" v-model="newStudentFull.student_tribal_or_indigenous_community.option" />
                                    <label class="text-xs px-1"> Yes </label>
                                    <span class="flex items-center whitespace-nowrap" :class="newStudentFull.student_tribal_or_indigenous_community.option === 'yes' ? '' : 'hidden'">
                                      <input type="text" v-model="newStudentFull.student_tribal_or_indigenous_community.name" placeholder="Name of Tribe" class="w-fit px-3 ml-2 mr-1 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" />
                                    </span>
                                  </span>
                                  <span class="flex items-center mx-1">
                                    <input type="radio" value="no" v-model="newStudentFull.student_tribal_or_indigenous_community.option" />
                          ...
                          <div class="lg:flex gap-3">
                            ...
                            <div class="lg:mb-0 mb-3" v-if="newStudent.former_lsu_student === 'yes'">
                              ...
                              <div class="flex">
                                ...
                                <span @click="infoText = !infoText" class="text-center cursor-pointer bg-green-800 font-bold border border-green-900 text-white rounded-full px-1.5 
                                                            h-5 w-5 ml-3 mt-2">
                                  <i class="fa fa-question mt-0.5 -ml-[1px] flex"></i>
                                </span>
                              </div>
                        ...
                        <div>
                          <div class="lg:px-5 lg:my-10 lg:py-5 px-2">
                            <div class="gap-3">
                                                    <div class="lg:flex gap-3">
                                                        <div class="w-full lg:mb-0 mb-3">
                                                            <label class="text-[10px] lg:text-gray-300 lg:block ">
                                                                Street or Purok
                                                            </label>
                                                            <input type="text"
                                                                class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                v-model="newStudentFull.student_contact_info.permanent_living_home_address_category.street_or_purok"
                                                        ...
                                                        <div class="w-full lg:mb-0 mb-3">
                                                            ...
                                                            <input type="text"
                                                                class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                v-model="newStudentFull.student_contact_info.permanent_living_home_address_category.barangay_or_village"
                                                        ...
                                                        <div class="w-full lg:mb-0 mb-3">
                                                            ...
                                                            <input type="text"
                                                                class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                v-model="newStudentFull.student_contact_info.permanent_living_home_address_category.city_or_municipality"
                                                        ...
                                                        <div class="w-full lg:mb-0 mb-3">
                                                            ...
                                                            <input type="text"
                                                                class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                v-model="newStudentFull.student_contact_info.permanent_living_home_address_category.zipcode"
                                                        ...
                                                        <div class="w-full lg:mb-0 mb-3">
                                                            ...
                                                            <input type="text"
                                                                class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                v-model="newStudentFull.student_contact_info.permanent_living_home_address_category.province_or_state"
                                                        ...
                                                        <div class="w-full lg:mb-0 mb-3">
                                                            ...
                                                            <input type="text"
                                                                class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                v-model="newStudentFull.student_contact_info.permanent_living_home_address_category.region"
                                                                placeholder="Region" />
                                                        </div>
                                                        ...
                                                        <div class="w-full lg:mb-0 mb-3">
                                                            ...
                                                            <input type="text"
                                                                class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                v-model="newStudentFull.student_contact_info.permanent_living_home_address_category.country"
                                                                placeholder="Country" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mb-3 lg:flex items-center lg:pt-3">
                                                    <p
                                                        ...
                                                        {{ newStudentFull.student_contact_info.the_same_address.question }}
                                                    </p>
                                                    ...
                                                    <div
                                                        ...
                                                        <div @click="theSameAddressBtn('yesStudentContactInfo')"
                                                            ...
                                                            :class="newStudentFull.student_contact_info.the_same_address.answer === 'yes' ? 'text-white bg-green-800' : 'text-green-800 bg-white border-2'">
                                                            yes</div>
                                                        ...
                                                        <div @click="theSameAddressBtn('noStudentContactInfo')"
                                                            ...
                                                            :class="newStudentFull.student_contact_info.the_same_address.answer === 'no' ? 'text-white bg-red-800' : 'text-red-800 bg-white border-2'">
                                                            no</div>
                                                    </div>

                                                </div>
                                                <div class="gap-3 mb-3"
                                                    :class="newStudentFull.student_contact_info.the_same_address.answer === 'yes' ? 'hidden' : ''">
                                                    <div class="lg:flex gap-3">
                                                        <div class="w-full lg:mb-0 mb-3">
                                                            <label class="text-[10px] lg:text-gray-300 lg:block ">
                                                                Street or Purok
                                                            ...
                                                            <input type="text"
                                                                class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                v-model="newStudentFull.student_contact_info.current_or_present_living_home_address_category.street_or_purok"
                                                                placeholder="Street or Purok" />
                                                        </div>
                                                        <div class="w-full lg:mb-0 mb-3">
                                                            <label class="text-[10px] lg:text-gray-300 lg:block ">
                                                            ...
                                                            <input type="text"
                                                                class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                v-model="newStudentFull.student_contact_info.current_or_present_living_home_address_category.barangay_or_village"
                                                                placeholder="Barangay or Village" />
                                                        </div>
                                                        <div class="w-full lg:mb-0 mb-3">
                                                            <label class="text-[10px] lg:text-gray-300 lg:block ">
                                                            ...
                                                            <input type="text"
                                                                class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                v-model="newStudentFull.student_contact_info.current_or_present_living_home_address_category.city_or_municipality"
                                                                placeholder="City or Municipality" />
                                                        </div>
                                                        <div class="w-full lg:mb-0 mb-3">
                                                            <label class="text-[10px] lg:text-gray-300 lg:block ">
                                                            ...
                                                            <input type="text"
                                                                class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                v-model="newStudentFull.student_contact_info.current_or_present_living_home_address_category.zipcode"
                                                                placeholder="Zip Code" />
                                                        </div>
                                                        <div class="w-full lg:mb-0 mb-3">
                                                            <label class="text-[10px] lg:text-gray-300 lg:block ">
                                                            ...
                                                            <input type="text"
                                                                class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                v-model="newStudentFull.student_contact_info.current_or_present_living_home_address_category.province_or_state"
                                                                placeholder="Province or State" />
                                                        </div>
                                                        <div class="w-full lg:mb-0 mb-3">
                                                            <label class="text-[10px] lg:text-gray-300 lg:block ">
                                                            ...
                                                            <input type="text"
                                                                class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                v-model="newStudentFull.student_contact_info.current_or_present_living_home_address_category.region"
                                                                placeholder="Region" />
                                                        </div>
                                                        <div class="w-full lg:mb-0 mb-3">
                                                            <label class="text-[10px] lg:text-gray-300 lg:block ">
                                                            ...
                                                            <input type="text"
                                                                class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                v-model="newStudentFull.student_contact_info.current_or_present_living_home_address_category.country"
                                                                placeholder="Country" />
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="lg:flex gap-3 lg:mt-5 border-t-4 pb-3 border-gray lg:pt-6 pt-3 lg:px-5 px-2">
                            <div class="lg:w-3/12 lg:mb-0 mb-3">
                              <label class="text-sm mb-1 text-black lg:block  font-bold"> 
                                Academic Year </label>
                              <div>
                                            ...
                                            <div class="w-full py-5">
                                                <div class="">
                                                    <p class="font-bold text-md text-green-900">
                                                        {{ newStudentFull.how_you_learn_about_lsu.question }}</p>
                                                    <ul class="ml-2">
                        ...
                        <div class="parents">
                          <div>
                                        <div class="parents lg:flex">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="flex w-full">
                                                            <input type="radio" value="living"
                                                                v-model="newStudentFull.father_personal_info.vital_life_status"
                                                    ...
                                                    <div class="py-5">
                                                        ...
                                                        <div class="lg:grid lg:grid-cols-3 gap-3">
                                                            ...
                                                            <div class="lg:mb-0 mb-3">
                                                                ...
                                                                <input type="text"
                                                                    class="w-full px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.father_personal_info.firstname"
                                                                    placeholder="First Name" />
                                                            </div>
                                                            <div class="lg:mb-0 mb-3">
                                                                <label
                                                                ...
                                                                <input type="text"
                                                                    class="w-full px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.father_personal_info.middlename"
                                                                    placeholder="Middle Name" />
                                                            </div>
                                                            <div v-if="fatherInfo" class="lg:mb-0 mb-3">
                                                                ...
                                                                <input type="text"
                                                                    class="w-full px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.father_personal_info.birth_date"
                                                            ...
                                                            <div class="lg:mb-0 mb-3" v-if="fatherInfo">
                                                                ...
                                                                <input type="text"
                                                                    class="w-full px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.father_personal_info.age"
                                                                    placeholder="Age" />
                                                            </div>
                                                            <div class="lg:mb-0 mb-3" v-if="fatherInfo">
                                                                <label
                                                                ...
                                                                <input type="text"
                                                                    class="w-full px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.father_personal_info.civil_status"
                                                                    placeholder="Civil Status" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="lg:py-5" v-if="fatherInfo">
                                                        ...
                                                        <div class="">
                                                            <div>
                                                                <label
                                                                    class="text-base text-black lg:block ">
                                                                ...
                                                                <div class="lg:grid grid-cols-3 gap-3">
                                                                  <div class="lg:mb-0">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        v-model="newStudentFull.father_contact_info.permanent_living_home_address_category.street_or_purok"
                                                                        placeholder="Street or Purok" />
                                                                  </div>
                                                                  ...
                                                                  <div class="lg:mb-0 mb-3">
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.father_contact_info.permanent_living_home_address_category.barangay_or_village"
                                                                        placeholder="Barangay or Village" />
                                                                  </div>
                                                                  ...
                                                                  <div class="lg:mb-0 mb-3">
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.father_contact_info.permanent_living_home_address_category.city_or_municipality"
                                                                        placeholder="City or Municipality" />
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.father_contact_info.permanent_living_home_address_category.zipcode"
                                                                        placeholder="Zip Code" />
                                                                  </div>
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.father_contact_info.permanent_living_home_address_category.province_or_state"
                                                                        placeholder="Province or State" />
                                                                  </div>
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.father_contact_info.permanent_living_home_address_category.region"
                                                                        placeholder="Region" />
                                                                  </div>
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.father_contact_info.permanent_living_home_address_category.country"
                                                                        placeholder="Country" />
                                                                  </div>
                                                            ...
                                                            <div class="mb-3 lg:flex items-center lg:pt-3">
                                                                <p
                                                                    class="text-xs text-green-900 mr-3 lg:pt-1 lg:text-left text-center">
                                                                    {{
                                                                        newStudentFull.father_contact_info.the_same_address.question
                                                                    }}
                                                                </p>
                                                                <div
                                                                    class="flex gap-3 pt-1 lg:mx-0 mx-auto w-fit lg:mb-0 mb-4 lg:mt-0 mt-2">
                                                                    <div @click="theSameAddressBtn('yesFatherContactInfo')"
                                                                        class="text-xs capitalize cursor-pointer px-3 rounded-lg hover:text-green-800 hover:bg-white border-2 border-green-800"
                                                                        :class="newStudentFull.father_contact_info.the_same_address.answer === 'yes' ? 'text-white bg-green-800' : 'text-green-800 bg-white border-2'">
                                                                        yes</div>
                                                                    <div @click="theSameAddressBtn('noFatherContactInfo')"
                                                                        class="text-xs capitalize cursor-pointer  px-3 rounded-lg hover:text-red-800 hover:bg-white border-2 border-red-800"
                                                                        :class="newStudentFull.father_contact_info.the_same_address.answer === 'no' ? 'text-white bg-red-800' : 'text-red-800 bg-white border-2'">
                                                                        no</div>
                                                                </div>
                                                            </div>
                                                            <div
                                                                :class="newStudentFull.father_contact_info.the_same_address.answer === 'yes' ? 'hidden' : ''">
                                                                <label
                                                                    class="text-base lg:text-gray-300 lg:block ">
                                                                ...
                                                                <div class="lg:grid grid-cols-3 gap-3">
                                                                  ...
                                                                  <div class="lg:mb-0">
                                                                    <label
                                                                      class="text-sm lg:text-gray-300 lg:block ">
                                                                      Street or Purok
                                                                  </label>
                                                                    <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.father_contact_info.current_or_present_living_home_address_category.street_or_purok"
                                                                        placeholder="Street or Purok" />
                                                                  </div>
                                                                  ...
                                                                  <div class="lg:mb-0 mb-3">
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.father_contact_info.current_or_present_living_home_address_category.barangay_or_village"
                                                                        placeholder="Barangay or Village" />
                                                                  </div>
                                                                  ...
                                                                  <div class="lg:mb-0 mb-3">
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.father_contact_info.current_or_present_living_home_address_category.city_or_municipality"
                                                                        placeholder="City or Municipality" />
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.father_contact_info.current_or_present_living_home_address_category.zipcode"
                                                                        placeholder="Zip Code" />
                                                                  </div>
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.father_contact_info.current_or_present_living_home_address_category.province_or_state"
                                                                        placeholder="Province or State" />
                                                                  </div>
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.father_contact_info.current_or_present_living_home_address_category.region"
                                                                        placeholder="Region" />
                                                                  </div>
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.father_contact_info.current_or_present_living_home_address_category.country"
                                                                        placeholder="Country" />
                                                                  </div>
                                                            ...
                                                            <div class="lg:flex gap-3">
                                                                <div class="w-full mb-3">
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.father_contact_info.contact.number"
                                                                ...
                                                                <div class="w-full">
                                                                    ...
                                                                    <input type="email"
                                                                        class="w-full px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.father_contact_info.contact.email_address"
                                                                        placeholder="Email Address" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="py-5" v-if="fatherInfo">
                                                        ...
                                                        <div class="lg:grid lg:grid-cols-2 gap-3">
                                                            <div class="mb-3 block">
                                                                ...
                                                                <input type="text"
                                                                    class="w-full px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.father_employment_info.highest_education_completed"
                                                            ...
                                                            <div class="mb-3 block">
                                                                ...
                                                                <input type="text"
                                                                    class="w-full px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.father_employment_info.occupation"
                                                            ...
                                                            <div class="mb-3 block">
                                                                ...
                                                                <input type="text"
                                                                    class="w-full px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.father_employment_info.employment_status"
                                                            ...
                                                            <div class="mb-3 block">
                                                                ...
                                                                <input type="text"
                                                                    class="w-full px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.father_employment_info.gross_monthly_income"
                                                            ...
                                                            <div class="mb-3 block">
                                                                ...
                                                                <input type="text"
                                                                    class="w-full px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.father_employment_info.employer_or_company"
                                            ...
                                            <div class="border-b-4 lg:px-10 px-3 py-5 lg:w-4/12 w-full">
                                                <div>
                                                    <div>
                                                        <p
                                                            class="text-green-800 uppercase font-bold mb-3 whitespace-nowrap">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="flex w-full">
                                                            <input type="radio" value="living"
                                                                v-model="newStudentFull.mother_personal_info.vital_life_status"
                                                                class="mr-2" @change="vitalLifeStatusSelection" />
                                                            <label class="text-[10px] ">
                                                                Living
                                                            </label>
                                                        ...
                                                        <div class="lg:grid lg:grid-cols-3 gap-3">
                                                            <div>
                                                                <label
                                                                    ...
                                                                    Last Name</label>
                                                                <input type="text"
                                                                    class="w-full mb-3 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.mother_personal_info.lastname"
                                                                    placeholder="Last Name" />
                                                            </div>
                                                            <div>
                                                                <label
                                                                ...
                                                                <input type="text"
                                                                    class="w-full mb-3 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.mother_personal_info.firstname"
                                                                    placeholder="First Name" />
                                                            </div>
                                                            <div>
                                                                <label
                                                                ...
                                                                <input type="text"
                                                                    class="w-full mb-3 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.mother_personal_info.middlename"
                                                                    placeholder="Middle Name" />
                                                            </div>
                                                            <div v-if="motherInfo">
                                                                <label
                                                                ...
                                                                <input type="text"
                                                                    class="w-full mb-3 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.mother_personal_info.birth_date"
                                                                    placeholder="Birth Date" />
                                                            </div>
                                                            <div v-if="motherInfo">
                                                                <label
                                                                ...
                                                                <input type="text"
                                                                    class="w-full mb-3 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.mother_personal_info.age"
                                                                    placeholder="Age" />
                                                            </div>
                                                            <div v-if="motherInfo">
                                                                <label
                                                                ...
                                                                <input type="text"
                                                                    class="w-full mb-3 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.mother_personal_info.civil_status"
                                                                    placeholder="Civil Status" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="py-5" v-if="motherInfo">
                                                        <p class="lg:mb-3 mb-2 font-bold text-green-800">
                                                          ...
                                                          <div class="">
                                                            <div>
                                                                ...
                                                                <div class="lg:grid grid-cols-3 gap-3">
                                                                  <div class="lg:mb-0">
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.mother_contact_info.permanent_living_home_address_category.street_or_purok"
                                                                        placeholder="Street or Purok" />
                                                                  </div>
                                                                  ...
                                                                  <div class="lg:mb-0 mb-3">
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.mother_contact_info.permanent_living_home_address_category.barangay_or_village"
                                                                        placeholder="Barangay or Village" />
                                                                  </div>
                                                                  ...
                                                                  <div class="lg:mb-0 mb-3">
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.mother_contact_info.permanent_living_home_address_category.city_or_municipality"
                                                                        placeholder="City or Municipality" />
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.mother_contact_info.permanent_living_home_address_category.zipcode"
                                                                        placeholder="Zip Code" />
                                                                  </div>
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.mother_contact_info.permanent_living_home_address_category.province_or_state"
                                                                        placeholder="Province or State" />
                                                                  </div>
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.mother_contact_info.permanent_living_home_address_category.region"
                                                                        placeholder="Region" />
                                                                  </div>
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.mother_contact_info.permanent_living_home_address_category.country"
                                                                        placeholder="Country" />
                                                                  </div>
                                                            ...
                                                            <div class="mb-3 lg:flex items-center lg:pt-3">
                                                                <p
                                                                    class="text-xs text-green-900 mr-3 lg:pt-1 lg:text-left text-center">
                                                                    {{
                                                                        newStudentFull.mother_contact_info.the_same_address.question
                                                                    }}
                                                                </p>
                                                                <div
                                                                    class="flex gap-3 pt-1 lg:mx-0 mx-auto w-fit lg:mb-0 mb-4 lg:mt-0 mt-2">
                                                                    <div @click="theSameAddressBtn('yesMotherContactInfo')"
                                                                        class="text-xs capitalize cursor-pointer px-3 rounded-lg hover:text-green-800 hover:bg-white border-2 border-green-800"
                                                                        :class="newStudentFull.mother_contact_info.the_same_address.answer === 'yes' ? 'text-white bg-green-800' : 'text-green-800 bg-white border-2'">
                                                                        yes</div>
                                                                    <div @click="theSameAddressBtn('noMotherContactInfo')"
                                                                        class="text-xs capitalize cursor-pointer  px-3 rounded-lg hover:text-red-800 hover:bg-white border-2 border-red-800"
                                                                        :class="newStudentFull.mother_contact_info.the_same_address.answer === 'no' ? 'text-white bg-red-800' : 'text-red-800 bg-white border-2'">
                                                                        no</div>
                                                                </div>
                                                            </div>
                                                            <div
                                                                :class="newStudentFull.mother_contact_info.the_same_address.answer === 'yes' ? 'hidden' : ''">
                                                                <label
                                                                    class="text-base lg:text-gray-300 lg:block ">
                                                                ...
                                                                <div class="lg:grid grid-cols-3 gap-3">
                                                                  ...
                                                                  <div class="lg:mb-0">
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.mother_contact_info.current_or_present_living_home_address_category.street_or_purok"
                                                                        placeholder="Street or Purok" />
                                                                  </div>
                                                                  ...
                                                                  <div class="lg:mb-0 mb-3">
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.mother_contact_info.current_or_present_living_home_address_category.barangay_or_village"
                                                                        placeholder="Barangay or Village" />
                                                                  </div>
                                                                  ...
                                                                  <div class="lg:mb-0 mb-3">
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.mother_contact_info.current_or_present_living_home_address_category.city_or_municipality"
                                                                        placeholder="City or Municipality" />
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.mother_contact_info.current_or_present_living_home_address_category.zipcode"
                                                                        placeholder="Zip Code" />
                                                                  </div>
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.mother_contact_info.current_or_present_living_home_address_category.province_or_state"
                                                                        placeholder="Province or State" />
                                                                  </div>
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.mother_contact_info.current_or_present_living_home_address_category.region"
                                                                        placeholder="Region" />
                                                                  </div>
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.mother_contact_info.current_or_present_living_home_address_category.country"
                                                                        placeholder="Country" />
                                                                  </div>
                                                            ...
                                                            <div class="lg:flex gap-3">
                                                                <div class="w-full mb-3">
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.mother_contact_info.contact.number"
                                                                        placeholder="Contact Number" />
                                                                </div>
                                                                <div class="w-full">
                                                                    <label
                                                                    ...
                                                                    <input type="email"
                                                                        class="w-full px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.mother_contact_info.contact.email_address"
                                                                        placeholder="Email Address" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="py-5" v-if="motherInfo">
                                                        ...
                                                        <div class="lg:grid lg:grid-cols-2 gap-3">
                                                            <div>
                                                                ...
                                                                <input type="text"
                                                                    class="w-full mb-3 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.mother_employment_info.highest_education_completed"
                                                                    placeholder="Highest Education Completed" />
                                                            </div>
                                                            <div>
                                                                <label
                                                                ...
                                                                <input type="text"
                                                                    class="w-full mb-3 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.mother_employment_info.occupation"
                                                                    placeholder="Occupation" />
                                                            </div>
                                                            <div>
                                                                <label
                                                                ...
                                                                <input type="text"
                                                                    class="w-full mb-3 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.mother_employment_info.employment_status"
                                                                    placeholder="Employment Status" />
                                                            </div>
                                                            <div>
                                                                <label
                                                                ...
                                                                <input type="text"
                                                                    class="w-full mb-3 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.mother_employment_info.gross_monthly_income"
                                                                    placeholder="Gross Monthly Income" />
                                                            </div>
                                                            <div>
                                                                <label
                                                                ...
                                                                <input type="text"
                                                                    class="w-full mb-3 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.mother_employment_info.employer_or_company"
                                                                    placeholder="Employer or Company" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div>
                                                        <div class="flex items-center">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                v-model="newStudentFull.legal_guardian_personal_info.relation_to_student"
                                                            ...
                                                            <div class="lg:grid grid-cols-3 gap-3">
                                                                <div>
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        v-model="newStudentFull.legal_guardian_personal_info.lastname"
                                                                        placeholder="Last Name" />
                                                                </div>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full mb-3 px-3 border-b-2 border-t-0 border-x-0 
                                                                        border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.legal_guardian_personal_info.firstname"
                                                                        placeholder="First Name" />
                                                                </div>
                                                                <div>
                                                                    <label
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full mb-3 px-3 border-b-2 border-t-0 border-x-0 
                                                                        border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.legal_guardian_personal_info.middlename"
                                                                        placeholder="Middle Name" />
                                                                </div>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full mb-3 px-3 border-b-2 border-t-0 border-x-0 
                                                                        border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.legal_guardian_personal_info.birth_date"
                                                                        placeholder="Birth Date" />
                                                                </div>
                                                                <div>
                                                                    <label
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full mb-3 px-3 border-b-2 border-t-0 border-x-0 
                                                                        border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.legal_guardian_personal_info.age"
                                                                        placeholder="Age" />
                                                                </div>
                                                                <div>
                                                                    <label
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full mb-3 px-3 border-b-2 border-t-0 border-x-0 
                                                                        border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.legal_guardian_personal_info.civil_status"
                                                                        placeholder="Civil Status" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                          ...
                                                          <div class="">
                                                            <div>
                                                                ...
                                                                <div class="lg:grid grid-cols-3 gap-3">
                                                                  <div class="lg:mb-0">
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.legal_guardian_contact_info.permanent_living_home_address_category.street_or_purok"
                                                                        placeholder="Street or Purok" />
                                                                  </div>
                                                                  ...
                                                                  <div class="lg:mb-0 mb-3">
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.legal_guardian_contact_info.permanent_living_home_address_category.barangay_or_village"
                                                                        placeholder="Barangay or Village" />
                                                                  </div>
                                                                  ...
                                                                  <div class="lg:mb-0 mb-3">
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.legal_guardian_contact_info.permanent_living_home_address_category.city_or_municipality"
                                                                        placeholder="City or Municipality" />
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.legal_guardian_contact_info.permanent_living_home_address_category.zipcode"
                                                                        placeholder="Zip Code" />
                                                                  </div>
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.legal_guardian_contact_info.permanent_living_home_address_category.province_or_state"
                                                                        placeholder="Province or State" />
                                                                  </div>
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.legal_guardian_contact_info.permanent_living_home_address_category.region"
                                                                        placeholder="Region" />
                                                                  </div>
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.legal_guardian_contact_info.permanent_living_home_address_category.country"
                                                                        placeholder="Country" />
                                                                  </div>
                                                            ...
                                                            <div class="mb-3 lg:flex items-center lg:pt-3">
                                                                <p
                                                                    class="text-xs text-green-900 mr-3 lg:pt-1 lg:text-left text-center">
                                                                    {{
                                                                        newStudentFull.legal_guardian_contact_info.the_same_address.question
                                                                    }}
                                                                </p>
                                                                <div
                                                                    class="flex gap-3 pt-1 lg:mx-0 mx-auto w-fit lg:mb-0 mb-4 lg:mt-0 mt-2">
                                                                    <div @click="theSameAddressBtn('yesGuardianContactInfo')"
                                                                        class="text-xs capitalize cursor-pointer px-3 rounded-lg hover:text-green-800 hover:bg-white border-2 border-green-800"
                                                                        :class="newStudentFull.legal_guardian_contact_info.the_same_address.answer === 'yes' ? 'text-white bg-green-800' : 'text-green-800 bg-white border-2'">
                                                                        yes</div>
                                                                    <div @click="theSameAddressBtn('noGuardianContactInfo')"
                                                                        class="text-xs capitalize cursor-pointer  px-3 rounded-lg hover:text-red-800 hover:bg-white border-2 border-red-800"
                                                                        :class="newStudentFull.legal_guardian_contact_info.the_same_address.answer === 'no' ? 'text-white bg-red-800' : 'text-red-800 bg-white border-2'">
                                                                        no</div>
                                                                </div>
                                                            </div>
                                                            <div
                                                                :class="newStudentFull.legal_guardian_contact_info.the_same_address.answer === 'yes' ? 'hidden' : ''">
                                                                <label
                                                                    class="text-base lg:text-gray-300 lg:block ">
                                                                    Mother Current Address
                                                                </label>
                                                                <div class="lg:grid grid-cols-3 gap-3">
                                                                  ...
                                                                  <div class="lg:mb-0">
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.legal_guardian_contact_info.current_or_present_living_home_address_category.street_or_purok"
                                                                        placeholder="Street or Purok" />
                                                                  </div>
                                                                  ...
                                                                  <div class="lg:mb-0 mb-3">
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.legal_guardian_contact_info.current_or_present_living_home_address_category.barangay_or_village"
                                                                        placeholder="Barangay or Village" />
                                                                  </div>
                                                                  ...
                                                                  <div class="lg:mb-0 mb-3">
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.legal_guardian_contact_info.current_or_present_living_home_address_category.city_or_municipality"
                                                                        placeholder="City or Municipality" />
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.legal_guardian_contact_info.current_or_present_living_home_address_category.zipcode"
                                                                        placeholder="Zip Code" />
                                                                  </div>
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.legal_guardian_contact_info.current_or_present_living_home_address_category.province_or_state"
                                                                        placeholder="Province or State" />
                                                                  </div>
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.legal_guardian_contact_info.current_or_present_living_home_address_category.region"
                                                                        placeholder="Region" />
                                                                  </div>
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.legal_guardian_contact_info.current_or_present_living_home_address_category.country"
                                                                        placeholder="Country" />
                                                                  </div>
                                                            ...
                                                            <div class="lg:flex gap-3">
                                                                <div class="w-full mb-3">
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.legal_guardian_contact_info.contact.number"
                                                                        placeholder="Contact Number" />
                                                                </div>
                                                                <div class="w-full">
                                                                    <label
                                                                    ...
                                                                    <input type="email"
                                                                        class="w-full px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.legal_guardian_contact_info.contact.email_address"
                                                                        placeholder="Email Address" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="lg:grid lg:grid-cols-2 gap-3">
                                                            <div>
                                                                ...
                                                                <input type="text" class="w-full px-3 border-b-2 border-t-0 border-x-0 
                                                                    border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.legal_guardian_employment_info.highest_education_completed"
                                                                    placeholder="Highest Education Completed" />
                                                            </div>
                                                            <div>
                                                                <label
                                                                ...
                                                                <input type="text" class="w-full px-3 border-b-2 border-t-0 border-x-0 
                                                                    border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.legal_guardian_employment_info.occupation"
                                                                    placeholder="Occupation" />
                                                            </div>
                                                            <div>
                                                                <label
                                                                ...
                                                                <input type="text" class="w-full px-3 border-b-2 border-t-0 border-x-0 
                                                                    border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.legal_guardian_employment_info.employment_status"
                                                                    placeholder="Employment Status" />
                                                            </div>
                                                            <div>
                                                                <label
                                                                ...
                                                                <input type="text" class="w-full px-3 border-b-2 border-t-0 border-x-0 
                                                                    border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.legal_guardian_employment_info.gross_monthly_income"
                                                                    placeholder="Gross Monthly Income" />
                                                            </div>
                                                            <div>
                                                                <label
                                                                ...
                                                                <input type="text" class="w-full px-3 border-b-2 border-t-0 border-x-0 
                                                                    border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                    v-model="newStudentFull.legal_guardian_employment_info.employer_or_company"
                                                                    placeholder="Employer or Company" />
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="border-b-4 lg:px-5 px-3 py-5">
                                                ...
                                                <div class="">
                                                    <div class="lg:grid grid-cols-6 gap-3">
                                                        <div class="w-full">
                                                            <label class="text-[10px] text-gray-300 lg:block ">
                                                                Title</label>

                                                            <input type="text" class="w-full px-3 border-b-2 border-t-0 border-x-0 
                                                                border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                v-model="newStudentFull.student_emergency_contact_information.personal_info.title"
                                                                placeholder="Title" />
                                                        </div>
                                                        <div class="w-full">
                                                            <label class="text-[10px] text-gray-300 lg:block ">
                                                            ...
                                                            <input type="text" class="w-full px-3 border-b-2 border-t-0 border-x-0 
                                                                border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                v-model="newStudentFull.student_emergency_contact_information.personal_info.lastname"
                                                                placeholder="Last Name" />
                                                        </div>
                                                        <div class="w-full">
                                                            <label class="text-[10px] text-gray-300 lg:block ">
                                                            ...
                                                            <input type="text" class="w-full px-3 border-b-2 border-t-0 border-x-0 
                                                                border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                v-model="newStudentFull.student_emergency_contact_information.personal_info.firstname"
                                                                placeholder="First Name" />
                                                        </div>
                                                        <div class="w-full">
                                                            <label class="text-[10px] text-gray-300 lg:block ">
                                                            ...
                                                            <input type="text" class="w-full px-3 border-b-2 border-t-0 border-x-0 
                                                                border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                v-model="newStudentFull.student_emergency_contact_information.personal_info.middlename"
                                                                placeholder="Middle Name" />
                                                        </div>
                                                        <div class="w-full">
                                                            <label class="text-[10px] text-gray-300 lg:block ">
                                                            ...
                                                            <input type="text" class="w-full px-3 border-b-2 border-t-0 border-x-0 
                                                                border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                v-model="newStudentFull.student_emergency_contact_information.personal_info.extension_or_suffix_name"
                                                        ...
                                                        <div class="w-full">
                                                            ...
                                                            <input type="text" class="w-full px-3 border-b-2 border-t-0 border-x-0 
                                                                border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                v-model="newStudentFull.student_emergency_contact_information.personal_info.relation_to_student"
                                                            ...
                                                            <div class="mb-5">
                                                                ...
                                                                <div class="lg:grid grid-cols-3 gap-3">
                                                                  <div class="lg:mb-0">
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.student_emergency_contact_information.address.street_or_purok.street_or_purok"
                                                                        placeholder="Street or Purok" />
                                                                  </div>
                                                                  ...
                                                                  <div class="lg:mb-0 mb-3">
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.student_emergency_contact_information.address.street_or_purok.barangay_or_village"
                                                                        placeholder="Barangay or Village" />
                                                                  </div>
                                                                  ...
                                                                  <div class="lg:mb-0 mb-3">
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.student_emergency_contact_information.address.street_or_purok.city_or_municipality"
                                                                        placeholder="City or Municipality" />
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.student_emergency_contact_information.address.street_or_purok.zipcode"
                                                                        placeholder="Zip Code" />
                                                                  </div>
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.student_emergency_contact_information.address.street_or_purok.province_or_state"
                                                                        placeholder="Province or State" />
                                                                  </div>
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.student_emergency_contact_information.address.street_or_purok.region"
                                                                        placeholder="Region" />
                                                                  </div>
                                                                  ...
                                                                  <input type="text"
                                                                        class="w-full lg:mb-3 mb-2 px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.student_emergency_contact_information.address.street_or_purok.country"
                                                                        placeholder="Country" />
                                                                  </div>
                                                            ...
                                                            <div class="lg:flex gap-3">
                                                                <div class="w-full">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.student_emergency_contact_information.contact.primary_number"
                                                                ...
                                                                <div class="w-full">
                                                                    ...
                                                                    <input type="text"
                                                                        class="w-full px-3 border-b-2 border-t-0 border-x-0 
                                                                        border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.student_emergency_contact_information.contact.alternate_number"
                                                                ...
                                                                <div class="w-full">
                                                                    ...
                                                                    <input type="email"
                                                                        class="w-full px-3 border-b-2 border-t-0 border-x-0 
                                                                        border-green-700 shadow-lg rounded-sm h-9 text-xs"
                                                                        v-model="newStudentFull.student_emergency_contact_information.contact.email_address"
                                                                        placeholder="Email Address" />
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        <div>
                          <div>
                                        <div class="border-b-4 lg:px-5 py-5">
                                            ...
                                            <div class="shadow py-2 px-3 mt-4 bg-green-100">
                                                <div class="lg:flex lg:py-3 py-2 gap-3">
                                                    <div class="w-full lg:mb-0 mb-3">
                                                        ...
                                                        <input
                                                            ...
                                                            v-model="newStudentFull.student_education_information_number.learner_reference_number" />
                                                    </div>
                                                    <div class="w-full lg:mb-0 mb-3">
                                                        ...
                                                        <input
                                                            ...
                                                            v-model="newStudentFull.student_education_information_number.ched_award_number" />
                                                    </div>
                                                    <div class="w-full lg:mb-0 mb-3">
                                                        ...
                                                        <input
                                                            ...
                                                            v-model="newStudentFull.student_education_information_number.dswd_household_number" />
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="w-full">
                                            <div class="lg:flex gap-3">
                                                <div class="w-full lg:block flex items-center lg:mb-0 mb-3">
                                                    ...
                                                    <select
                                                        v-model="newStudentFull.student_choice.choice_track_program_one_course_program"
                                                        class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs">
                                                ...
                                                <div class="w-full lg:block flex items-center lg:mb-0 mb-3">
                                                    ...
                                                    <select
                                                        v-model="newStudentFull.student_choice.choice_track_program_two_course_program"
                                                        class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs">
                                                        <option value="" disabled selected>Select Course Program
                                                        </option>
                                                        <option :value="cp" v-for="(cp, i) in programDataOnly"
                                                ...
                                                <div class="w-full lg:block flex items-center lg:mb-0 mb-3">
                                                    ...
                                                    <select
                                                        v-model="newStudentFull.student_choice.choice_track_program_three_course_program"
                                                        class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs">
                                                        <option value="" disabled selected>Select Course Program
                                                        </option>
                                                        <option :value="cp" v-for="(cp, i) in programDataOnly"
                  ...
                  <div class="border-t-2 border-green-700 mt-5 shadow-lg" v-show="toggle.three">
                    <div>
                      <h2 class="lg:text-base text-xs px-10 uppercase py-2 font-bold bg-green-900 text-white text-center"> MEDIA RELEASE CONSENT </h2>
                      <div class="shadow lg:px-10 px-3 pt-5 pb-10 text-green-900">
                        <p class="lg:text-sm text-xs mb-5">
                        ...
                        <ul class="list-disc ml-10 mb-3">
                          <li v-for="(j, i) in staticNewStudentTexts.media_release_consent.list" :key="i" class="lg:text-sm text-xs">
                            {{ j }}
                          </li>
                        </ul>
                        <p class="lg:text-sm text-xs mb-3">
                        ...
                        <p class="lg:text-sm text-xs mb-4 text-green-800">
                        ...
                        <div class="mt-10">
                          <div class="my-3 flex items-center">
                            ...
                            <label class="lg:text-sm text-xs font-bold text-green-900"> AGREE </label>
                          </div>
                          <div class="flex items-center">
                            <input type="radio" class="mr-1.5" v-model="newStudent.media_release_consent" value="DO NOT AGREE" />
                            <label class="lg:text-sm text-xs font-bold text-green-900"> DO NOT AGREE </label>
                          </div>
                        </div>
                      </div>
                      <div class="py-5">
                        <div class="justify-between flex">
                          <div @click="toggleInfo(
                            false, true, false, false, false)" class="cursor-pointer py-1 uppercase px-4 shadow bg-green-800 text-white hover:bg-white hover:text-green-800 rounded-lg mx-2">
                            <i class="fa fa-angle-double-left pr-2"></i> Prev
                          </div>
                          <div class="cursor-pointer py-1 uppercase px-4 shadow bg-green-800 text-white hover:bg-white hover:text-green-800 rounded-lg mx-2" @click="toggleInfo(
                            false, false, false, true , false)">Next <i class="fa fa-angle-double-right pl-2"></i>
                          </div>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="border-t-2 border-green-700 mt-5 shadow-lg" v-show="toggle.four">
                    <div>
                      ...
                      <div class="shadow lg:px-10 px-3 py-5 text-green-900">
                        ...
                        <div class="my-3 flex items-center mt-10">
                          <input type="checkbox" class="mr-1.5" v-model="newStudent.has_health_condition.answer" value="true" />
                      ...
                      <div class="py-5">
                        <div class="justify-between flex">
                          <div @click="toggleInfo(
                            false, false, true, false, false)" class="cursor-pointer py-1 uppercase px-4 shadow bg-green-800 text-white hover:bg-white hover:text-green-800 rounded-lg mx-2">
                            <i class="fa fa-angle-double-left pr-2"></i> Prev
                          </div>
                          <div class="cursor-pointer py-1 uppercase px-4 shadow bg-green-800 text-white hover:bg-white hover:text-green-800 rounded-lg mx-2" @click="toggleInfo(
                            false, false, false, false, true)">Next <i class="fa fa-angle-double-right pl-2"></i>
                          </div>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="border-t-2 border-green-700 mt-5 shadow-lg" v-show="toggle.five">
                    <div>
                      ...
                      <div class="lg:flex py-5 border-t-4 border-green-800 justify-between">
                        <div class="flex items-center lg:mb-0 mb-20">
                          <div @click="toggleInfo(
                                false, false, false, true, false)" class="flex items-center cursor-pointer py-1 uppercase 
                ...
                <div v-if="pleaseFillUpAllRequiredFields" class="my-10 text-white bg-red-800 font-bold text-center py-1 px-5 block lg:text-sm text-xs"> All fields are required information. Otherwise, type N/A if not applicable. </div>
              </div>
            </div>
          </div>
        </div>
