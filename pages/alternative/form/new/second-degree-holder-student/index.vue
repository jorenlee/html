<script setup>
  ...
  const newStudent = ref({
    tracking_id: "TIDNSD" + moment().valueOf(),
  ...
  const courseSelectionSecondDegree = ref();
...
const theSameAddressBtn = (choice) => {
  ...
  const submitToAPI = async () => {
    await $fetch(endpoint.value + "/api/admissions-first-sem/second-degree-holder/create/", {
      method: "POST",
      headers: {
        "Content-Type": "application/json"
      },
  ...
  let assignCollegeSecondCourser = () => {
    newStudent.value.second_degree_holder_student.college = courseSelectionSecondDegree.value.college
    newStudent.value.second_degree_holder_student.program = courseSelectionSecondDegree.value.program
  }
  let assignCollege = () => {
      ...
      <div>
        <div class="w-11/12 mx-auto shadow lg:px-8 px-3 lg:py-7 py-2 lg:mt-10 mt-3 lg:mb-3">
          <h1 class="font-bold lg:text-2xl text-xs text-green-800 text-center"> 
            APPLICATION FOR UNDERGRADUATE STUDENTS : Second Degree Holder Status </h1>
            <p class=" text-center cursor-default lg:text-sm text-xs">
              ...
              <div class="">
                <ul class="flex justify-between">
                  <li class="w-full ">
                    ...
                    <p class="text-left lg:text-xs text-[10px]  mt-5  text-green-800 lg:whitespace-nowrap lg:flex hidden"> Student Information </p>
                  </li>
                  <li class="w-full ">
                  ...
                  <div class="border-t-2 border-green-700 mt-5 shadow-lg" v-show="toggle.one">
                    <div>
                                  ...
                                  <div class="lg:flex gap-3 w-full lg:mb-0 mb-3">
                                    <div class="w-full">
                                      ...
                                      <input type="text" class="w-full capitalize border-b-2 border-t-0 border-x-0 border-green-700 
                                                                            shadow-lg rounded-sm h-9 text-xs" placeholder="Last Name" v-model="newStudent.lastname" />
                                    </div>
                                    <div class="w-full">
                                      <label class="text-[10px] text-gray-900 lg:block  pb-1">First Name</label>
                                      <input type="text" class="w-full capitalize border-b-2 border-t-0 border-x-0 border-green-700 
                                                                            shadow-lg rounded-sm h-9 text-xs" placeholder="First Name" v-model="newStudent.firstname" />
                                    </div>
                                    <div class="w-full">
                                      <label class="text-[10px] text-gray-900 lg:block  pb-1">Middle Name</label>
                                      <input type="text" class="w-full capitalize border-b-2 border-t-0 border-x-0 border-green-700 
                                                                            shadow-lg rounded-sm h-9 text-xs" placeholder="Middle Name" v-model="newStudent.middlename" />
                                    </div>
                                  </div>
                                  <div class="lg:flex gap-3">
                                    <div>
                                    ...
                                    <div>
                                      ...
                                      <div>
                                        <input type="date" class="lg:w-44 w-full border-b-2 border-t-0 border-x-0 
                                                                border-green-700 shadow-lg rounded-sm h-9 text-xs" placeholder="Date of Birth" v-model="newStudent.birth_date" />
                                      </div>
                                    </div>
                        ...
                        <div class="mt-3 lg:pb-5 pb-3 lg:px-5 px-2">
                          <div class="lg:flex gap-3">
                            ...
                            <div class="w-full lg:mb-0 mb-3">
                              ...
                              <div>
                                <input type="email" class="w-full text-xs px-3 border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9" placeholder="e.g name7@gmail.com" v-model="newStudent.contact_personal_email_address" required />
                              </div>
                            </div>
                          ...
                          <div class="lg:flex gap-3 mt-5 pb-2 border-gray pt-4 border-t-4">
                            <div class="lg:w-3/12 lg:mb-0 mb-3">
                              <label class="text-sm mb-1 text-black lg:block  font-bold"> Academic Year </label>
                              <div>
                                <input type="text" disabled class="w-full text-xs px-3 border-b-2 border-t-0 
                                                                border-x-0 bg-gray-100 shadow-lg rounded-sm h-9" value="A.Y. 2024 to 2025" />
                              </div>
                            </div>
                            <div class="lg:w-3/12 lg:mb-0 mb-3">
                              ...
                              <div>
                                <input type="text" disabled class="w-full text-xs px-3 border-b-2 border-t-0 
                                                                border-x-0 bg-gray-100 shadow-lg rounded-sm h-9" value="First Semester" />
                              </div>
                            </div>
                            <div class="lg:w-full mx-auto lg:mb-0 mb-3">
                            ...
                            <div class="lg:w-full mx-auto lg:mb-0">
                              <label class="text-sm mb-1 text-black lg:block  capitalize font-bold"> previous Degree program graduated </label>
                              <select v-model="courseSelectionSecondDegree" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg 
                                                           rounded-sm text-black h-9 text-xs">
                                <option value="Select Course Program" selected disabled>Select Course Program</option>
                                <option :value="cp" v-for="(cp, i) in courseOrProgramData" :key="i">
                                  {{ cp.college }} | {{ cp.program }}
                                </option>
                      ...
                      <div class="border-b-4 py-2">
                        <div class="lg:px-5 px-2 lg:mb-5 mb-5">
                          <div class="lg:flex lg:pt-3 gap-3">
                            <div class="lg:mb-0 mb-3 lg:w-3/12">
                              <label class="font-bold lg:text-sm text-xs text-black w-fit whitespace-nowrap pr-10 pb-1 block"> Last Term Graduated </label>
                              <select v-model="newStudent.last_term_graduated" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs">
                            ...
                            <div class="lg:mb-0 mb-3 lg:w-3/12">
                              <label class="flex font-bold lg:text-sm text-xs text-black w-fit whitespace-nowrap pr-10 pb-1">
                                <span>Last Academic Year Graduated</span>
                              </label>
                              <select v-model="newStudent.last_academic_year_graduated" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs">
                            ...
                            <div class="w-full">
                              <label class="font-bold lg:text-sm text-xs text-black w-fit whitespace-nowrap pr-10 pb-1 block"> Last School Graduated </label>
                              <input v-model="newStudent.last_school_graduated" type="text" class="w-full px-3 capitalize border-b-2 border-t-0 border-x-0 border-green-700 shadow-lg rounded-sm h-9 text-xs" placeholder="Last School Attended" />
                            </div>
                  ...
                  <div class="border-t-2 border-green-700 my-5 shadow-lg" v-show="toggle.two">
                    <div>
                      ...
                      <div class="pb-5">
                        ...
                        <div class="lg:flex gap-3 mt-5 border-t-4 pb-3 border-gray pt-6 lg:px-5 px-2">
                            <div class="lg:w-3/12 lg:mb-0 mb-3">
