<script setup>
  ...
  const deleteItem = async () => {
    await $fetch(
      endpoint.value + "/api/admissions-first-sem/student-profile/" + idToBeDeleted.value + "/delete/",
      {
        method: "DELETE",
        headers: {
    ...
    <div class="w-full">
      ...
      <div class="px-3 pt-5">
        <div class="lg:flex items-center mb-5">
            <div class="w-6/12 flex items-center lg:mt-0 mt-5">
              <input v-model="searchText" 
              type="text" 
              class="shadow-lg search w-full border border-b-4 
                border-green-800 h-8 rounded-lg" 
                placeholder="Search Name or LSU ID or Tracking ID then press Enter" 
                @change="filterSearch()" />
            </div>
          </div>
        
          <div class="w-full h-[2000px] bg-white z-10  px-5 
...
<!-- 
          ...
          border-green-900 py-2 tracking-widest font-bold">
            ...
            <div class="">
              <div class="shadow mx-auto text-xs">
                <div class="">
                  <div class="lg:flex hidden header w-full px-1.5 py-2 bg-green-800 text-white items-center shadow-lg">
                    <ul class="flex  w-full lg:whitespace-nowrap">
                      ...
                      <li class="cursor-pointer uppercase" :class="toggleTrackingIDColumn ? 'lg:w-2/12' :'w-20'" 
                      @click="toggleTrackingIDColumn = !toggleTrackingIDColumn">
                  ...
                  <div class="w-full" v-if="bookingAppointmentListFilter.length > 0">
                    <ul
                      class="lg:py-1 lg:flex justify-between w-full items-center h-auto border-b 
                      border-gray-100 border lg:mb-0 mb-3 py-1 relative hover:bg-gray-200"
                     ...
                     <span v-else>
                      ...
                      <li
                        class="flex justify-center font-bold px-2 text-xs 
                        text-green-800 lg:w-fit lg:static absolute top-2 right-2">
                        <div class="w-auto px-1 flex gap-5">
                            ...
                            class="cursor-pointer hover:bg-white hover:text-yellow-600 border-yellow-600 border-2
                             bg-yellow-500 text-white uppercase font-bold px-2 py-1 
                             rounded-lg tracking-tighter text-[10px]"> Update </button>
                            <button
                            v-if="
                              userStore.user.email === 'jorenleeluna24@gmail.com' ||
                              userStore.user.email === 'admissions@lsu.edu.ph'
                    ...
                    <div
                      class="px-5 rounded-lg bg-white shadow-2xl absolute top-1/2 
               ...
               <div v-if="bookingAppointmentListFilter.length > initialDisplay"
                class="flex items-center justify-center lg:w-[600px] 
                w-fit mx-auto font-bold text-sm rounded-lg my-5">
                <div @click="prev"
                  class="mt-[2px] border-b-[5px] border-t-[1px] border-r-[1px] border-l-[1px] 
                ...
                <div @click="next"
                  ...
                  hover:text-white text-green-950 shadow px-2 py-1.5 rounded-tr-lg rounded-br-lg">
                  Next
