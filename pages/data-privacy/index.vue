      ...
      <div class="w-full">
        <div class="lg:bg-white bg-green-900 lg:pb-10 pb-7 lg:text-green-800 text-white">
          ...
          <div class="lg:flex items-center lg:w-10/12 w-11/12 mx-auto border bg-white border-green-950 shadow-lg">
            <img src="https://lsu-media-styles.sgp1.digitaloceanspaces.com/lsu-public-images/banners/LSU%20NPC%20REGISTRATION%20CERT-1.png" class="lg:w-8/12 lg:border-r-4 mx-auto lg:border-b-0 border-b-4" />
            <img src="https://lsu-media-styles.sgp1.digitaloceanspaces.com/lsu-public-images/banners/logo/NPC-SEAL-FOR-LSU.png" class="lg:w-[250px] w-[150px] mx-auto px-5 lg:my-0 my-3" />
          </div>
        </div>
      </div>
